...
\begin{itemize}
\item Going from Morse, no presupposition.
\item Straightforward confidence of a kind.
\item Arresting Woodthorpe, there is a presupposition.
\item Hence, something is different about Lewis' reasoning.
  \begin{enumerate}
  \item Confident that presupposition can be met.
    And, this confidence is in effect the same as Lewis' confidence that there is a demonstration based on Morse's message.
  \end{enumerate}
\item Does Lewis' promise do enough?
  \begin{enumerate}
  \item Lewis is not arresting Woodthorpe on the basis of Woodthorpe's guilt.
  \item Instead, on the basis of:
    \begin{enumerate}
    \item Lewis' confidence of guilt, and
    \item Lewis's confident that guilt can be demonstrated.
    \end{enumerate}
  \item The difference is an assumption.
  \item However, it seems this assumption is made when Lewis promises to demonstrate Woodthorpe's guilt.
  \item So, this distinction doesn't force a particular path.
  \end{enumerate}
\end{itemize}
...
\begin{itemize}
\item Key is the evaluation of Lewis' action.
\item Whether this depends on Lewis' eventual reasoning, or whether this only depends on Lewis' expectations about the future.
\end{itemize}

\begin{itemize}
\item Could press things further by supposing that this is the only chance to arrest Woodthorpe.
\end{itemize}
