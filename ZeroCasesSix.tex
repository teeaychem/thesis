...
\item Stated in full\dots
  \[
    ...
    \left(
      \begin{array}{l}
        \everb{reason} \land \\
        \ein{\exists e'(\everb[e']{cry} \land \eagent[e']{Caesar})} \land \\
        \eout{\text{Ought}
        \left(\exists e''\left(
        \begin{array}{l}
          \everb[e'']{hug} \land \\
          \eagent[e'']{Brutus} \land \\
          \epatient[e'']{Caesar}
        \end{array}
        \right)
        \right)
...
\item Lewis arrests Woodthorpe without reasoning from the case file to the guilt of Woodthorpe.
...
\item Where does this confidence come from?
