...
\begin{scenario}[Pythagoras and Shang Gao]
  Pythagoras and Shang Gao share a square hot tub measuring three by four meters.
  Pythagoras prefers lukewarm water, while Shang Gao prefers hot water.
  Pythagoras reflects on this problem and realises that as the heating element is placed in one corner of the hot tub, a divider separating the hot tub into two halves would leave the half without the heating element lukewarm.
  Exhausted by this realisation, Pythagoras asks Shang Gao the hypotenuses of a three by four square.
  Shang Gao replies that if one has a three by four square then the hypotenuses is five.
  Pythagoras then places an order for a five meter divider.
\end{scenario}
