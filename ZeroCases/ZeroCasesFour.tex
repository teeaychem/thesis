...
In these examples, \(a\) and \(f_{P}\) are fresh, and \(\psi\) is inferred on the basis of these, and because no assumptions are made regarding \(a\) and \(f_{P}\), one can be sure that \(P\) holds of some transformation of \(a\).
