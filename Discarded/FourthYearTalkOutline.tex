...
\begin{itemize}
  ...
  \begin{tikzpicture}
    ...
    % https://fineartamerica.com/featured/wind-in-the-willows-rowing-boat-scene-philip-mendoza.html
    \node[anchor=south west,inner sep=0] (image) at (0,0) {\includeinkscape{images/witw}};
  \end{tikzpicture}
\end{center}

\subsubsection{Akraisa}
\label{sec:akraisa}
% https://www.pngfuel.com/free-png/onowt glass and cheese
% https://www.pngflow.com/en/free-transparent-png-tmeta bottle and two glasses
