...
\begin{note}
  I may want to change these to \(\Box\phi \vdash \Box\Box\phi\), for example.
  This keeps the idea of treating everything on the left as a description of a state as kind of nice, and avoids the use of \(\rightarrow\).
\end{note}
