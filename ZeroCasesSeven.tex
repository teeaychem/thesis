...
\begin{enumerate}
\item\label{keyPoint:poss-no-supp} It is possible to require \(\phi\) to be true without providing support for \(\phi\) independent of claiming an agent has the ability to demonstrate \(\phi\).
\end{enumerate}

If \ref{keyPoint:poss-no-supp} holds, there remains the possibility of the agent obtaining support for the fact via the ability claim itself.
