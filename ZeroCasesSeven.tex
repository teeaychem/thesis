...
\begin{itemize}
\item Basic arithmetic explains why \(22^{2} = 484\).
\item When calculating \dots you form an attitude toward the proposition that \(22^{2} = 484\) based on those explanatory reasons.
\item Agent belies that \(22^{2} = 484\) on the basis of basic arithmetic.
\item By contrast:
\item Someone telling you, using a calculator, inferring from a receipt, etc.\ may explain why you hold it to be true that \(22^{2} = 484\).
\item Here, the explanatory reasons are mediated.
\item Agent belies that \(22^{2} = 484\) on the basis of testimony.
\end{itemize}

\begin{itemize}
\item In some cases explanatory reasons aren't available.
\item Require an intermediary.
\item Grasp of arithmetic only goes so far, e.g.\ Fermat's Last Theorem.
\end{itemize}

\begin{itemize}
\item Rephrase the above.
\item \(22^{2} = 484\) but you don’t need me, anyone else, or anything else, to tell you.
\item \(22^{2} = 484\) on the basis of basic arithmetic, but you have the ability to figure this out by yourself.
\item Testimony.
\item Why do I hold it to be true that \(22^{2} = 484\)?
\item Because you have told me.
\item Contained in your assertion is the claim that \(22^{2} = 484\), etc.\
\item Likewise for the claim that \(22^{2} = 484\) on the basis of basic arithmetic.
\item Note that this is different from holding that \(22^{2} = 484\) on the basis of arithmetic.
\item The former is a proposition about a relation held on the basis of testimony.
\item The latter is a relation held between propositions, etc.\
  \begin{itemize}
  \item Subtle difference, needs work.
  \item Roughly:
    \begin{enumerate}
    ...
    \end{enumerate}
  \item In both cases there is a relation between \(\phi\) and \(\Sigma\).
  \item However, it is only in the second case that \(\Sigma\) is the basis on which the agent holds that \(\phi\).
  ...
  \item In the first case, the agent needs \emph{additional} support.
    \begin{itemize}
    \item Testimony doesn't necessarily provide additional reason.
    \item Rather, the agent isn't in a position to hold that \(\phi\) holds on the basis of \(\Sigma\) without additional support.
    \end{itemize}
  \item These observations about support are the key to understanding what is going on here.
  \item The situation is complex.
    \begin{itemize}
    \item There's something like a subtle \emph{use/mention} distinction going on.
    \item For, the first instance is akin to a mention of the structural relation, while the second is a use of the structural relation.
    \item {\color{red} Some terminology would be useful here!}
    \end{itemize}
  \end{itemize}
  \begin{enumerate}
  \item However, you have also told me that you did not need to tell me.
  \item I have the ability to show that \(22^{2} = 484\) holds on the basis of basic arithmetic.
  \item So, I do not need to appeal to testimony to support holding \(22^{2} = 484\) on the basis of arithmetic.
  \item I have access to those explanatory reasons.
  \end{enumerate}
\item There's nothing too special about this.
\item I can form this dependency relations fairly easily.
\end{itemize}



\begin{itemize}
\item You don't need me to tell you because you have a grasp on basic arithmetic, and with some effort can demonstrate that \(22^{2} = 484\).
  Even if this comes from repeated addition.
\item So, you hold it is true that \(22^{2} = 484\).\nolinebreak
  \footnote{
    Not going to claim that you believe this.
    More on this later.
  }
\item This is what is communicated.
\item There are other ways to read this.
  You don't need me to tell you because there are other ways, independent of your own ability, to discover that \(22^{2} = 484\).
  Calculators, websites, looking at the total on a receipt after purchasing 22 items costing 22 dollars, etc.
\item The thing is we can easily turn this into an interrogative.
\item \(22^{2} = 484\) and you don’t need me to tell you, do you?
\item \(22^{2} = 484\) and you don’t need me (or anyone else) to tell you, do you?
\item So, on what basis do you hold \(22^{2} = 484\)?
\item Reasonable to say on the basis of basic arithmetic.
\item Following \citeauthor{Neta:2019aa}, distinguish between reasons \emph{why} and reasons \emph{for which}.
\item Reasons why are not always reasons for which.
\item But, metaphorically, you haven't formed as a `response' to those reasons.
\end{itemize}
