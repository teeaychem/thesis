...
\begin{note}[Gist]
  Ability expands only so long as the strategy exists.

  General problem is similar to the zoo cases.
...
1  However, the principle that is employed is distinct from confidence.
