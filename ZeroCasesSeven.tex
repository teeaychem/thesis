...
\begin{note}[Narrowing cases]
  ...
  % Explanation seems secure.
  % Doubt that an account which is everywhere redundant can be a best account.
  % Hence, licensing seems unlikely to be a best account.

  % This rests on a conjecture that there will explanations are better than potential explanations.
  ...
  % Enough of these to motivate licensing in specific, though generic, cases.
\end{note}
