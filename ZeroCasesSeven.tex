...
\begin{note}[Quick argument]
  ...
  \item So, either some additional support, or the agent rejects the conditional.
  \end{enumerate}
...
\begin{note}[Abilities]
  Issues about transmission failure have been explored.
  ...
  First:
  Typically, no further information.
  However, ability changes this.

  Second:
  The conditional provided is not a straightforward entailment.
