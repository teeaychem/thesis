...
The informer has only communicated the ability claim.

Agent obtains the fact from the ability claim, but avoids the factive inference.

Similar to the previous point, the focus is on what is communicated, and focus is on specific situations.
The counter-position is, however, broad.
In place of sketching a general strategy, begin by suggesting one type of strategy.
Then turn to emphasising the agent's ability, and why this blocks general strategies of this kind.
