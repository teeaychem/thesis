...
\begin{enumerate}
\item Two pieces of information.
  \begin{enumerate}
...
For the arguments that follow, it's that we're dealing with ability claimed embedded in the antecedents of conditionals.

This is important, however.
To make clear that the agent is not straightforwardly attributing an ability.

So, look, there are cases like this.
If today is Thursday, then Tomorrow is Friday. (Said to a small child.)
