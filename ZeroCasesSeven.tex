...
I am inclined to think the agent is `on the hook', and therefore the agent may avoid endorsing the ability claim and request the informer provide support.
...
The chess problem is simple, and on a good day there is some enjoyment to be had from doing this.
