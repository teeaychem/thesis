...
The distinction I am interested in can be seen as distinction between the way a reason which may support an attitude.
}
...
\(7^{3} = 343\), but I do not consider the result of calculator a reason to hold that \(7^{3} = 343\).
The calculator informed me that, given my understanding of arithmetic, I may hold that \(7^{3} = 343\).

Compare to \(\ln(\pi)\).
This goes beyond me ability.
