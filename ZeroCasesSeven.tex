...
\begin{figure}[h]
  ...
  \begin{subfigure}{.4\textwidth}
    ...
    \end{adjustbox}
    \caption{Example fields White cannot prevent Black from occupying in two moves.}
...
{
  \color{red}
  I need to make the above more explicit and detailed, but it seems that the next thing to do is to provide some examples to help motivate what is going on now that there's some theoretical background added.
}
