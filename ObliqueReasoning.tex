...
From this it is easy to slip to the conclusion that an agent can only engage in practical reasoning with what they can represent, and that if an agent cannot represent the end to their means they cannot appropriately reason about their means \emph{as means}.
...
That the agent will recognise it when they see it gets to the possibility, and that they've not voided anything by going to the supermarket.
