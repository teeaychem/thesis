...
In line with the standard picture of means-end reasoning, means have significance only in so far as they allow an agent to achieve some end.
What is interesting about these scenarios is how and why certain means persist without an agent being in a position to evaluate the relevant end.
