...
\begin{note}[Attribution]
  The conflict between~\nI{} and attribution requires the assumption from~\ref{prop:SE}.
...
This is why~\ref{prop:SE} is phrased in terms of information, rather than support.

\nI{} does not prevent the agent from using the proposition.
\ref{prop:SE} only denies that the agent obtains support.
...
\begin{note}[Too narrow]
  Hold that the exception made by~\ref{prop:SE} is too narrow to be of general interest.
