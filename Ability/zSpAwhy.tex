...
\begin{note}
  ...
  \begin{proposition}
    ...
    \item[\emph{Then}:]
      \begin{enumerate}[label=\alph*., ref=(\alph*), resume]
      \item \support{2} between \(\pv{\psi}{v'}\) and \(\Psi\) (from \vAgent{}' perspective), in part, answers \qWhyV{}.
      \end{enumerate}
    \end{enumerate}
  \end{proposition}
...
\begin{note}
  ...
  \footnote{
    ...
    Consider a Gentzen system for propositional logic termed \textbf{G3c}(\textbf{p}) (\cite[\S3.5]{Troelstra:2000ue},\cite[\S3.1]{Negri:2008wy}).
