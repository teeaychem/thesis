...
\begin{note}[Way]
  ...
  Still, as I am unsure of whether~\autoref{assu:event:way} holds in general, our full proposal works with sub-events rather than the way in which an event develops.
\end{note}
...
\begin{note}
  ...
  \begin{definition}[\drAdj{2} instance of event]
    ...
    \item
      ...
      \begin{itemize}
      \item
        In the collection \closeW{0} to \(w\) such that \(g^{\flat}\) happens, \(g^{\flat}\) is a stage of \(e\).
      \end{itemize}
    \end{itemize}
  \end{itemize}
  \vspace{-\baselineskip}
...
\begin{note}
  ...
  Repeating these ideas, through repeated applications of \AlgAC{}, \AlgGetStops{}, and \AlgFindBranches{}, I see no reason to deny the possibility of an event in which Rebecca walks across the minefield.
\end{note}
