...
\begin{note}[Neutral perspective]
  ...
  Still, before turning to \pevent{1}, observe that whether \(\pvp{\phi}{v}{\Phi}\) is a \fc{0} is stated from a neutral perspective --- at issue is whether there is a \pevent{} in which the agent concludes.
...
\begin{note}
  Progressive.
  Share similarity with the act conditional analysis.
  Choice of action.
  Difference is that \(S\) \(\varphi\)s is not a consequence of the action.
  Instead, consequence of the action is that \(S\) is \(\varphi\)\emph{ing}.
\end{note}
