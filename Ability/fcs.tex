...
\begin{note}
  ...
  Additional \illu{1} of \fc{1} follow in later chapters as the idea of a \fc{0} is central to the way in which we characterise \ros{1}, and the way in which we generate counterexamples to \issueInclusion{}.
\end{note}
