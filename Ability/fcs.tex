...
\begin{note}
  ...
  \begin{proposition}
    ...
    If \(\pvp{\phi}{v}{\Phi}\) is a \fc{0}, then (a) potential (relation of) \support{} holds between \(\pv{\phi}{v}\) and \(\Phi\).
  \end{proposition}
...
\begin{note}
  \begin{proposition}
    ...
    (A) potential (relation of) \support{} holds between \(\pv{\phi}{v}\) and \(\Phi\) only if (a relation of) \support{} holds between \(\pv{\phi}{v}\) and \(\Phi\).
  \end{proposition}
...
\begin{note}
  ...
  Maybe work with accounts of ability?
\end{note}
...
\begin{note}
  I think I might be able to apply analysis of what ability entailments involve here.
  No, this gets odd.
  Because, with actuality, get that the thing really happened.
  Here, I'm getting that some property holds.

  Well, there are two senses.
  First, it doesn't hold that the entailment works for concluding.
  However, it does hold that the entailment works for support.

  But, then, this is easy to get.
  Because, we just need to well, the verb is the copula.
  Well, perfective, event as whole.
  Can't be it, as then would work for concluded.

  So, only holds with property.
  In this sense, avoid the most puzzling things about actuality entailments.
\end{note}
