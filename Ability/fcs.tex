...
\begin{note}
  ...
  Final \illu{}.
  \begin{illustration}[Cards]
    An agent is presented with a shuffled deck of playing cards and is asked to choose a number \(n\) greater than \(1\) but less than \(53\).
...
\begin{note}
  ...
  Rather than consider stops in the actual world, consider stops of the same event in reasonable worlds.
...
\begin{note}
  \color{red}
  HERE I NEED TO INCLUDE THESE, AS POSSIBLE FAILURE.
  Note, branch.
