...
\begin{note}
  ...
  And, by assumption the \agents{} understanding of chess sufficient to conclude \ref{illu:fc:chess:I:c}, and the agent has already inspected the game board.

  Second, consider following (motivated) conditionals:
  ...
  \begin{scenario}[ジョジョリオン]%
    ...
    \begin{center}
      ...
      \begin{tabular}{R{.45\textwidth} L{.45\textwidth}}
        ...
        Every day is summer holiday & 毎日が夏休み \\
