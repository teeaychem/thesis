...
\begin{note}[Expanding on~\ref{nI:inclusion}]
  ...
  In particular, \ref{nI:background} and~\ref{nI:inclusion} combine to ensure that \(\psi\) would be an expectation of the claimed support for \(\phi\).
  Hence:
  \begin{quote}
    \vspace{-\baselineskip}
    \assuCSRExp*
  ...
  In~\ref{sec:claim-supp-expect}, \ref{assu:independence-expec}.

  And, as \expec{} goes to \requ{}:
