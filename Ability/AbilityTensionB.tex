...
\begin{note}
  ...
  \expec{1} is weaker, so applies more generally.
...
\begin{note}[Setting \expec{1}]
  ...
  For now, I hope to have appropriately set \expec{1} with respect to following argument.
\end{note}
