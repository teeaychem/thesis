...
\begin{note}
  ...
  \begin{itenum}
  \item[\emph{If}:]
    A \ros{} between \propI{What they said was an appropriate sign}, \valI{True} and some \pool{} \(\Psi\) fails to hold.
  \item[\emph{Then}:]
  ...
  \end{itenum}
  %
  In contrast to \scen{1} \ref{illu:gist:roots:F} and \ref{illu:gist:roots:QF}, the highlighted \ros{} \propI{What they said was an appropriate sign}, \valI{True} and \(\Psi\) is distinct from the \ros{} which characterises Fox's final conclusion.
  ...
  Still, the \ros{} between \propI{What they said was an appropriate sign}, \valI{True} and \(\Psi\) is tightly connected to \emph{whether} Fox is concluding \propI{The person I'm talking to is a member of the Democratic Underground Party} has value \valI{True} from \(\Phi\) by the second conditional.%
  \footnote{
...
\begin{note}
  ...
  Likewise, in the case of \autoref{scen:countS} we considered a \ros{} between \propI{What Pritcher said was an appropriate sign}, \valI{True} and some \pool{} \(\Psi\) with respect to Fox and noted the if the \ros{} fails to hold, Fox does not conclude Pritcher is a member of The Party.
  In this respect, the \ros{} favours an event in which Fox concludes \propI{The person I'm talking to is a member of The Party} has value \valI{True} from some \pool{} \(\Phi\).
  ...
  For, example, a \ros{} between \propI{What Pritcher said was an appropriate sign}, \valI{True} and some \pool{} \(\Psi\) fails to answer \qWhy{} Fox concluded \propI{What Pritcher said was an appropriate sign} has value \valI{True} from \(\Psi\) as the \ros{} did not hold prior to Fox's (intermediate) conclusion.
...
\begin{note}
  ...
  And, with respect to \autoref{scen:countS} the \ros{} of interest holds between \propI{What Pritcher said was an appropriate sign}, \valI{True} and some \pool{} \(\Psi\).
  Fox has concluded \propI{What Pritcher said was an appropriate sign} has value \valI{True} from \(\Psi\) when Fox concludes \propI{The person I'm talking to is a member of The Party} has value \valI{True} from some \pool{} \(\Phi\).
\end{note}
