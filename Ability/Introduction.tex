...
\begin{note}
  ...
  \begin{question}{questionWhy}{\qWhy{}}
    ...
    \begin{itemize}
    \item
      Which \ros{1} (partially) explain \emph{why} \(e\) is an event in which \vAgent{} concludes \(\phi\) has \val{0} \(v\) from \(\Phi\) (rather than some other event)?
    \end{itemize}
  ...
  \begin{question}{questionHow}{\qHow{}}
    ...
    \begin{itemize}
    \item
      Which past or present events (partially) explain \emph{how} \(e\) is an event in which \vAgent{} concludes \(\phi\) has \val{0} \(v\) (rather than some other event)?
    \end{itemize}
    \vspace{-1.5\baselineskip}
  \end{question}
\end{note}
...
\begin{note}
  ...
  Clause~\ref{idea:why:favour} is satisfied as the agent figuring out \rootsConEqFac{} favours an event in which the agent concludes \pv{\propI{\rootsCon{}}}{\valI{True}} from the \pool{} over an event in which the agent fails to conclude \pv{\propI{\rootsCon{}}}{\valI{True}} from the \pool{}.
  In short, an event in which the agent concludes \pv{\propI{\rootsCon{}}}{\valI{True}} when the agent figures out \rootsConEqFac{} is in progress.
...
\begin{note}
  ...
  \item
    ...
    So, a \ros{} between \pv{\propI{\rootsCon{}}}{\valI{True}}, and a \pool{} which captures the \agents{} understanding of factorisation answers \qWhy{}, as the \agents{} eventual conclusion is favoured over any event in which the agent does not conclude \pv{\propI{\rootsCon{}}}{\valI{True}} from the relevant \pool{}.
  \end{itemize}
  %
  ...
  In this respect, the \ros{} between \(\psi\), \(v'\), and \(\Psi\) is part of what it is for an an event in which the agent concludes \(\phi\) has \val{0} \(v\) from \(\Phi\) to be favoured over some other event.
  %
  \begin{itemize}
  \item
