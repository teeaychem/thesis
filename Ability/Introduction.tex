...
\begin{note}
  ...
  \noindent%
  Applying \prop{1}, \val{1}, and \pool{1}, we say that in the event described by \autoref{scen:countS} Fox concludes \propI{The person I'm talking to is a member of the Democratic Underground Party} has value \valI{True} from some \pool{} \(\Phi\).
  And, when Fox \evals{} \propI{The person I'm talking to is a member of The Party} as having \valI{True}, a \ros{} holds between \propI{The person I'm talking to is a member of The Party}, \valI{True}, and \(\Phi\).%
  \footnote{
    Pritcher tells Fox the are a member of The Party at the end of the \scen{}.
    Still, Fox has already drawn the conclusion when Fox asks `Who are you?' via the sequence of countersigning.
  }

  Further, after Pritcher's opening gambit `I come from Miran', Fox (sub-)concludes \propI{What they said was a sign} has \val{0} \valI{True} and some \pool{} \(\Psi\).
  And, of interest is with the \ros{} between \propI{What they said was a sign}, \valI{True} and some \pool{} \(\Psi\).
  ...
  And, the \ros{} does not ensure Fox is concluding \propI{The person I'm talking to is a member of The Party} has value \valI{True} from \(\Phi\).

  Still, the \ros{} is tightly connected to \emph{whether} Fox is concluding \propI{The person I'm talking to is a member of The Party} has value \valI{True} from \(\Phi\) by the second conditional.
  ...
  \end{itenum}
  %
  And, if Fox doesn't think Pritcher is engaging in countersign, Fox does not conclude Pritcher a fellow member of The Party by countersign.
  ...
  \item[\emph{Then}:]
    Fox does not conclude \propI{The person I'm talking to is a member of The Party} has value \valI{True} from some \pool{} \(\Phi\).
  \end{itenum}
  %
...
\begin{note}
  ...
  In this respect, the \ros{} favours an event in which Fox concludes \propI{The person I'm talking to is member of The Party} has value \valI{True} from some \pool{} \(\Phi\).
  ...
  Though, as noted above, the \ros{} favours Fox's (overall) conclusion that \propI{The person I'm talking to is a member of The Party} has value \valI{True} from \(\Phi\).
\end{note}
...
\begin{note}
  ...
  Fox has concluded \propI{What Pritcher said was a sign} has value \valI{True} from \(\Psi\) when Fox concludes \propI{The person I'm talking to is a member of The Party} has value \valI{True} from some \pool{} \(\Phi\).
\end{note}
...
\begin{note}
  ...
  \end{quote}
  %
  Of course, various \scen{1} which the recipe plausibly applies to will be given, and the relevant resources are designed to identify common \scen{1}, the sort of \scen{1} that happen to multiple people on any given day.
  ...
  Hence, it may be the case that the \scen{1} identified by the recipe are understood to exist, and \issueConstraint{} fails to hold given this understanding, though it turns out that what's really going on in each \scen{0} identified is compatible with \issueConstraint{}.
  Still, I take this to be on par with showing \issueInclusion{} fails to hold.
\end{note}


\begin{note}
  In short, the goal of this document is to show that any \scen{0} which satisfies a collection of features entails \issueInclusion{} does not hold.
  ...
  Though, I will not argue \emph{in full} that the relevant features really do capture particular \scen{1}.%
  \footnote{
