...
\begin{note}
  ...
  And, Clause~\ref{idea:why:favour} is satisfied as an \eiw{0} the agent concludes \pv{\propI{\rootsCon{}}}{\valI{True}} when the agent figures out \rootsConEqFac{} is in progress.
  Hence, the agent figuring out \rootsConEqFac{} favours an \eiw{0} the agent concludes \pv{\propI{\rootsCon{}}}{\valI{True}} from the \pool{} over, e.g., an \eiw{0} the agent fails to conclude.
...
\paragraph*{The sense of `how' at issue in \qHow{}}
