...
\begin{note}
  ...
  And, it need not be the case that, given \(y = \sqrt{2 + \sqrt{ 2 + \sqrt{2 + \cdots}}}\), a \ros{} holds between \propM{y = 2}, \valI{True}, and the \agents{} understanding of factorisation (even though it is clear \(y^{2} - y - 2 = 0\) given a little insight).
\end{note}
