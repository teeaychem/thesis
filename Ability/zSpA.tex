...
\begin{note}
  Property of the qualifier.

  So, may hold or fail to hold.

  Examples.
\end{note}

\subparagraph{Relation to proposition}
...
\begin{note}
  ...
  At issue is whether there is some qualifier, so that \ptivity{} fails, and qualified answers \qzS{}.
  If so, then it need not be the case that there is.
\end{note}
...
\begin{note}[Knowledge]
  \ptivity{} clearly holds for knowledge.
...
\begin{note}
  Looking ahead, also belief.
  Belief just is what is the case from perspective.

  Note, here appeal to principle of knowledge for first case.
  While, second case only proposed analysis of belief.

  {
    \color{red}
    \citeauthor{Moore:1993wk}'s paradox?
  }
\end{note}
...
\begin{note}
  ...
  Long black lines which are crossed with short black lines.

  Seems the long black lines are not parallel.

  To keep this interactive, slight twist.
  If you are familiar with \citeauthor{Zollner:1860vx} illusion, then long black lines are parallel to one another.

  However, variation.

  So long as it seems to you the black lines are not parallel, and you have used anything to determine whether they are parallel.
  No stance on whether they are parallel.
  If variation cropping, then are parallel.
  If variation altered, might be parallel.
  ...
  If \ptivity{} holds, then from your perspective.
  However, enough, I think, to withhold moving from how things seem to how things are.

  Used the term `seem', but want to capture this distinction.
\end{note}
...
\begin{note}
  ...
  With this \scen{}, focus is what hold with respect the following proposition when assigned value true, from Cypher's perspective:

  \begin{itemize}
  \item
    There is a steak in Cypher's mouth which is both juicy and delicious.
  \end{itemize}

  From the first statement made by Cypher, the steak does not exist.
  From the second statement, it (the non-existing) steak is both juicy and delicious.

  Puzzling, but some qualifier.

  \begin{itemize}[noitemsep]
  \item
    It is not the case there is a steak in Cypher's mouth which is both juicy and delicious, from Cypher's perspective.
  \item
    Cypher misrepresents that there is a steak in Cypher's mouth which is both juicy and delicious, from Cypher's perspective.
  \end{itemize}
\end{note}

\subparagraph{Other \scen{1}}

\begin{note}[Other examples]
  Failure is often difficult.
...
\begin{note}
  Now, \ptivity{} is the core idea.

  Noted, if some attitude, possible.

  Link between \ptivity{} failing and answers to questions.
...
\subparagraph{Question relativity}
