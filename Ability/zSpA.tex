  ...
  \begin{principle}[\ptivity{2}]
    ...
    \item[]
      ...
      \item[\emph{If}]
        ...
        \item
          \(\phi\) is \ptivityQV{}'d to have value \(v\) from \agpe{\vAgent{}'}.
        \end{enumerate}
      \item[\emph{then}]
        \begin{enumerate}[label=\alph*., ref=(\alph*), resume]
        \item
          \(\phi\) has value \(v\) from \agpe{\vAgent{}'}.
        \end{enumerate}
      \end{enumerate}
    \end{itemize}
    \vspace{-\baselineskip}
...
\begin{note}[Knowledge]
  ...
  \begin{principle}[Factivity of knowledge, relative to perspective]
    ...
    \vAgent{} knows \(\phi\) has value \(v\), from \agpe{\vAgent{}'} \emph{only if} \(\phi\) has value \(v\), from \agpe{\vAgent{}'}.
  \end{principle}
\end{note}
...
\begin{note}[Caution]
  ...
  \factivity{2}, as stated above, talks about whether an agent knows \(\phi\) has value \(v\) independently of any (particular) \agpe{}.
...
\begin{note}
  ...
  \item
    ...
    I believe it is not raining, though it is raining, from \agpe{my}.
  \end{enumerate}
  ...
  \item
    ...
    It is not raining, from \agpe{my}.
  \end{enumerate}
...
\begin{note}
  ...
  \footnote{
    ...
    \item
      ...
      I believe it is raining, from \agpe{my}.
    \end{enumerate}
    ...
    \item
      ...
      I believe I believe it is not raining, from \agpe{my}.
    \end{enumerate}
...
\begin{note}
  ...
  \begin{itemize}[noitemsep]
  \item
    It \emph{seems} long black lines are not parallel, from \agpe{your}.
  \item
    The long black lines are neither parallel nor not parallel, from \agpe{your}.
  \end{itemize}

  Here, `seems' is being used as a qualifier for which \ptivity{} does not hold.
  Indeed, if \ptivity{} were to hold for `seems' then it would follow that the long black lines are not parallel, from \agpe{your}.
  ...
  \begin{itemize}[noitemsep]
  \item
    It \emph{seems} long black lines are not parallel, from \agpe{my}.
  \item
    The long black lines are parallel, from \agpe{my}.%
    \footnote{
      Unfortunately, the variation is limited to a simple crop of~\textcite{Fibonacci:2007vj}'s image.
    }
  \end{itemize}

  The long black lines are parallel, from \agpe{my}, as I've analysed the image using tools.
  However, the illusion continues to hold, and it remains the case that it \emph{seems} the long black lines are not parallel, from \agpe{my}.
...
\begin{note}
  ...
  With this \scen{}, our interest is with what hold with respect the following proposition when assigned value true, from \agpe{Cypher's}:
  ...
  From the first statement made by Cypher, the steak does not exist, so the proposition is not true from \agpe{Cypher's}.
  ...
  \begin{itemize}[noitemsep]
  \item
    It is not the case there is a steak, from \agpe{Cypher's}.
  \item
    Cypher misrepresents that there is a steak, from \agpe{Cypher's}.
  \end{itemize}
  Some term other than `misrepresents' may work equally well.
  Though, whichever term is chosen, the point remains the same:
  Cypher is aware that they are in the Matrix, and therefore from \agpe{Cypher's}, Cypher's thoughts regarding objects `in' the Matrix are qualified, from \agpe{Cypher's}.
\end{note}
...
\begin{note}[The principle]
  \ptivityQ{2} is a straightforward variation of \ptivity{}, in which the move from a proposition-value pair holding under some qualifier (from an \agpe{}) to the proposition-value pair holding from the \agpe{} is tied to a fixed question.
  ...
  \begin{principle}[\ptivityQ{2}]
    ...
    \item[\emph{If}]
      \begin{enumerate}[label=\alph*., ref=(\alph*)]
      \item
        \(\phi\) is \ptivityQV{}'d to have value \(v\) answers \emph{Q}, from \agpe{\vAgent{}'}.
      \end{enumerate}
    \item[\emph{then}]
      \begin{enumerate}[label=\alph*., ref=(\alph*), resume]
      \item
        \(\phi\) has value \(v\) answers \emph{Q}, from \agpe{\vAgent{}'}.
      \end{enumerate}
    \end{enumerate}
    \vspace{-\baselineskip}
  \end{principle}
...
\begin{note}
  ...
  {
    \color{red}
    \(\qzSaV{}\) involves, in part, \agpe{\vAgent{}'} that \(\pvp{\psi}{v'}{\Psi}\) is a \fc{}.
  }
...
\begin{note}
  ...
  In these cases, the agent recognises that it's only \agpe{their}.
  So, in these cases, the agent is appealing to what holds from \agpe{their}.
