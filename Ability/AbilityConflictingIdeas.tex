...
\begin{note}
  Previous successful \illu{1} are instances of \USE{}.
  \label{illu:requ:import-export}, \label{illu:textbook-answers}, \label{illu:mom:clock} clock.

  And, unsuccessful, not due to omotting premises.

  From \autoref{sec:illustrations-wrt-assumption}
