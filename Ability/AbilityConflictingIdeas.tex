...
\begin{note}
  ...
  \footnote{
    As with footnote \ref{fn:use:failure-hyperlinks}, the \illu{1} implicitly referenced are: \ref{illu:requ:bank},~\ref{illu:requ:import-export}, and~\ref{illu:textbook-answers} from \autoref{sec:def-of-requ} and \ref{illu:mom:clock} from~{\color{red} ???}.
  }
\end{note}
