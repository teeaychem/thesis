...
\begin{note}
  ...
  \begin{motivation}{obs:se-inst}
    ...
    \noindent%
    Our task is to show \autoref{def:se} hold with respect to some description \(d'\).
      ...
      \item
        {
          ...
          % is such that \(\ed{}\) is in progress \emph{only if} feature \(f\) of \(\edo{\flat}\) holds throughout \(\ed{\flat}\).
          }
      \end{itemize}
    \item[\emph{Then:}]
