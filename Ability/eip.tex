...
\begin{note}
  ...
  \begin{motivation}{obs:se-need-hCon}
    Suppose an agent is passing an exam without external help.
    Then, a classmate passes the agent some answers, which the agent uses.
    The agent passes the exam, but the agent passing the exam does not happen as a result of the agent passing the exam without external help.
    For, the agent passes the exam of the result being handed some answers.
  \end{motivation}
\end{note}
