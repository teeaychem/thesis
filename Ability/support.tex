...
\begin{note}
  Applied to \scen{1}~\ref{illu:gist:roots:F}~and~\ref{illu:gist:roots:QF} \supportI{} entails a \ros{} between \pv{\propM{\rootsCon{}}}{\valI{True}} and a \pool{} which captures the \agents{} understanding of factorisation or the quadratic formula holds when the agent concludes.
...
\begin{note}
  To help understand the role of \supportII{}, we return to \autoref{illu:gist:roots:F} and argue a \ros{} between \pv{\rootsCon{}}{\valI{True}} and some \pool{} \(\Phi\) which captures the \agents{} understanding of factorisation answers \qWhy{}.
