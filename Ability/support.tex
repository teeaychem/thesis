...
\begin{note}
  \supportII{} characterises when a \ros{} to hold between some \prop{0}-\val{0} pair and \pool{} from an \agpe{} \emph{without} an event in which the agent concludes the \prop{0}-\val{0} pair from the \pool{}.
...
\begin{note}
  ...
  The second contrasts our understanding of the connexion between \ros{1} and an event in which an agent concludes to \citeauthor{Boghossian:2014aa}'s understanding of the connexion between `support' an event in which an agent infers.
