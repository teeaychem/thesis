...
\begin{note}
  Lost keys, might reason to a different conclusion.

  Thing is about reasoning to different conclusions.
  Then, a variant \illu{} with the idea of a partial check.
\end{note}
    ...
    \item
      ...
      \item
        ...
        \item
          ...
          For any proposition-value pair \(\pv{\psi_{i}}{v_{i}}\) in \(\Psi\), \vAgent{} either:
          \begin{enumerate}
          \item Has concluded \(\pv{\psi_{i}}{v_{i}}\) without concluding \(\pv{\phi}{v}\) from \(\Phi\).
          \item May conclude \(\pv{\psi_{i}}{v_{i}}\) without concluding \(\pv{\phi}{v}\) from \(\Phi\).
          \end{enumerate}
        \end{enumerate}
      \item
      ...
      \item
        ...
        \item[\emph{If}:]
          ...
          \item
            ...
            \vAgent{} has the option of concluding \(\pv{\psi}{v'}\) from \(\Psi\), given the agent's reasoning to \(\pv{\phi}{v}\) from \(\Phi\).
          \end{enumerate}
        \item[\emph{And}:]
...
\begin{note}
  Quantification is general, but the core of \qzS{} is a conditional, and the conjunction of clauses which form the antecedent of the conditional (\ref{question:zs:option} and \ref{question:zs:subjunctive}) place significant constraints on the proposition-value-premises pairings of interest.
  For, if either \ref{question:zs:option} or \ref{question:zs:subjunctive} fails to hold, the conditional will be true.

  \ref{question:zs:option}, option.
  \ref{question:zs:subjunctive}, failure.

  Our interest is with cases where both~\ref{question:zs:option} and~\ref{question:zs:subjunctive} hold for some \(\pvp{\psi}{v'}{\Psi}\)-pairing.
\end{note}
