...
\begin{note}
  ...
  \begin{sketch}
    ...
    \vspace{-\baselineskip}
  \end{sketch}
  Clause~\ref{skech:zS:fail:requ} is shared between~\autoref{sketch:zS:fail} and~\autoref{sketch:zS:succeed}.

  The difference between~\autoref{sketch:zS:fail} and~\autoref{sketch:zS:succeed} is with respect to clause~\ref{sketch:zS:fail:no-c}.
...
\begin{note}[\requ{3}]
  ...
  Familiar from clause~\autoref{sketch:zS:succeed:requ} of~\autoref{sketch:zS:fail} and~\ref{sketch:zS:succeed}.
  ...
  With respect to \scen{1}, \requ{} is half, or two thirds of the story.
...
\paragraph{(Partial) check on reasoning}
...
\begin{note}
  ...
  In contrast to the idea of a \requ{}, the agent's perspective is a core component of \qzS{}.
  ...
  Links to \requ{}.
  \requ{} states, if fail to conclude, would not conclude \(\pv{\phi}{v}\) from \(\Phi\).
  \qzS{}, holds from agent's perspective.
  And, from agent's perspective, would conclude.

  Above, \requ{} links opportunity and subjunctive ability.
  Intuitively, \qzS{} asks whether subjunctive ability is present ability.

  Link between what the 
\end{note}
