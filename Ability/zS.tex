...
\begin{note}
  \begin{idea}[\autoref{question:zs} and \emph{Why}]
    ...
    \begin{itemize}
    \item
      Negative answer to~\autoref{question:zs} answers, in part, why an agent does not conclude.
    \item
      Positive answer to~\autoref{question:zs} answers, in part, why an agent does conclude, and hence is, in part, an answer to both \qWhy{} and \qWhyV{}.
    \end{itemize}
  \end{idea}

  The point here is that the negative answer seems sufficiently clear.
  Hence, the question is important.
  So, positive answer is also important.
\end{note}
