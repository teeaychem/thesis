...
\begin{note}
  ...
  \begin{dets}{obs:LucasRequ}
    ...
    And, as \(\edo{\flat}\) as a natural description of \(\edn{\flat}\), it take it to be clear an \eiw{0} the agent concludes \pv{\propM{L_{[:9]} = [2, \dots, 76]}}{\valI{True}} from \(\Phi\) is in progress.
    \smallskip
