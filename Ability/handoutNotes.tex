...
\begin{itemize}
\item
  Understanding the way an \eiw{0} an agent concludes happens.

  Two questions, why and how.

  Whether answers to how constrain answers to why.
\item
  The plan is to cover, roughly, the foundations of the thesis.

  The two questions, the constraint, and the way answers to \qWhy{} are obtained.
  So, I will not present an abridged version of the overall argument of the thesis.
\item
  A handout, rather than slides.
\item
