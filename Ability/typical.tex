...
\begin{note}
  ...
  Begin with a helper definition to ease intuitions.
  Then define \tR{}.
\end{note}
...
\begin{note}
  ...
  As focus is on available actions, progressive.

  Idea is that whatever it is which secures the truth of progressive, it is securing reasoning of type \(T\).
