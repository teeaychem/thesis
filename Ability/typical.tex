...
\begin{note}
  ...
  \begin{proposition}[Factorisation: \torNa{}, \pool{}]%
    ...
    \begin{itenum}
    \item[\emph{If}:]
      \(\ed{\flat}\) is an event in which \vAgent{} is concluding \(\pv{\phi}{\valI{True}}\) from \(\Phi\).
    \item[\emph{Then}:]
      \(\ed{\flat}\) is an event in which \vAgent{} is \tCV{} \(\pv{\phi}{\valI{True}}\) from some \pool{} \(\Phi\) by factorisation.
    \end{itenum}
    \vspace{-\baselineskip}
  \end{proposition}
  ...
  \begin{argument}{prop:p-t}
    Suppose \(\ed{\flat}\) is an event in which \vAgent{} concludes \(\pv{\phi}{\valI{True}}\) from \(\Phi\).
    ...
    Therefore, \(\ed{\flat}\) is an event in which \vAgent{} is \tCV{} \(\pv{\phi}{\valI{True}}\) from some \pool{} \(\Phi\) by factorisation.
    \medskip
