...
\begin{note}
  ...
  Hence, some work is required to show the agent is concluding \pv{\rootsCon{}}{\valI{True}} from from a \pool{} which includes \rootsConEq{} and the \agents{} understanding of factorisation by factorisation \emph{only if} the agent would be concluding \pv{\propI{\rootsConGen{}}}{\valI{True}} from some \pool{} if the agent did some action.
