...
\begin{note}
  ...
  \begin{proposition}[Factorisation: \torNa{}, \pool{}]%
    ...
    \begin{itenum}
    \item[\emph{If}:]
      \(\ed{}\) is an event in which \vAgent{} is concluding \(\pv{\phi}{\valI{True}}\) from \(\Phi\).
    \item[\emph{Then}:]
      \(\ed{}\) is an event in which \vAgent{} is \tCV{} \(\pv{\phi}{\valI{True}}\) from some \pool{} \(\Phi\) by factorisation.
    \end{itenum}
    \vspace{-\baselineskip}
  \end{proposition}
  ...
  \begin{argument}{prop:p-t}
    Suppose \(\ed{}\) is an event in which \vAgent{} concludes \(\pv{\phi}{\valI{True}}\) from \(\Phi\).
    ...
    Therefore, \(\ed{}\) is an event in which \vAgent{} is \tCV{} \(\pv{\phi}{\valI{True}}\) from some \pool{} \(\Phi\) by factorisation.
    \medskip
