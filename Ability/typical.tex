...
\subsection{Representatives of a type of reasoning}
...
\begin{note}
  \begin{restatable}[Representative of a type of reasoning]{definition}{defToRRep}
    ...
    \begin{itemize}
    \item
      \(T'\) is representative of type of reasoning \(T\) for \vAgent{} with respect to event \(e\).
    \end{itemize}
    ...
    \item
      ...
      \begin{itemize}
      \item
        \emph{If} \(e\) is an event such that \vAgent{}' reasoning is of type \(T'\) \emph{then} \(e\) is an event such that \vAgent{}' reasoning is of type \(T\).
      \end{itemize}
    \end{itemize}
    \vspace{-\baselineskip}
  \end{restatable}

  Role of this definition is to allow distinction between type and reasoning the reasoning the agent performs.
\end{note}
...
\begin{note}
  \begin{definition}[\tR{2}]
    ...
    \begin{itemize}
    \item
      \vAgent{}' reasoning to \(\pv{\phi}{v}\) from \(\Phi\) is an instance of \emph{\tR{0}} of type \(T\).
    \end{itemize}
    ...
    \begin{itemize}
    \item
      For some representative \(T'\) of the type of reasoning \(T\).
      Any \(\pvp{\psi}{v'}{\Psi}\).
