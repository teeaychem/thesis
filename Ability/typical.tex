...
\begin{note}
  ...
  First, there is a close connexion between an agent \ptCV{} \(\pv{\phi}{v}\) from \(\Phi\) and \(\pv{\phi}{v}\) from \(\Phi\) being a \fc{}, given both ideas build on \pevent{1}.
  ...
  \begin{argument}{prop:tCV-ptCV}
    ...
    Then, by \autoref{idea:tR-law} there is some collections \({\cal E}\) of events and \({\cal X}\) of \prop{0}-\val{0}-\pool{0}~pairings such that:
