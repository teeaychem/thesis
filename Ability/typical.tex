...
\begin{note}
  ...
  Then, narrow this idea for purposes with definition.
\end{note}
...
\begin{note}
  ...
  \begin{illustration}[Modus ponens]
    Collection of proposition-value-\pool{} pairs \(T\):
    ...
    \item
      ...
      \begin{itemize}
      \item
        \pv{P}{\val{True}}, \pv{\prop{If }P\prop{ then }Q}{\val{True}}, and \pv{Q}{\val{True}}.
      \end{itemize}
    \end{itemize}
    ...
    \item
      ...
      \begin{itemize}
      \item
        \pv{P}{\val{True}}, \pv{\prop{If }P\prop{ or }Q\prop{ then }R}{\val{True}} with \pv{R}{\val{True}}
      \item
        \pv{P}{\val{True}}, \pv{\prop{If }P\prop{ then }Q}{\val{True}} with \pv{Q}{\val{False}}
      \end{itemize}
    \end{itemize}
    Where, \(P\), \(Q\), and \(R\) are descriptions.
  \end{illustration}
\end{note}
...
\begin{note}
  ...
  Scenarios where properties hold, but the agent does not know.

  Here, three properties.

  Analysis of knowledge.
  However, as analysis, entails.

  For any scenario, if properties, then agent knows.

  Contrast, reasoning is an activity, and no interest in agent neutral \torN{1}.

  \citeauthor{Gettier:1963aa}.
...
\begin{note}
  The Ellsberg paradox (\cite{Ellsberg:1961aa}), \citeauthor{Makinson:1965aa}'s Paradox of the Preface (\citeyear{Makinson:1965aa}), or \citeauthor{Kyburg:1997aa}'s Lottery Paradox (\citeyear{Kyburg:1997aa}).

  Here, belief and conjunction.

  Following Gettier\dots
...
\begin{note}
  Similar to \citeauthor{Harman:1984aa}'s interest in the relation between logical principles and belief revision (\citeyear{Harman:1984aa,Harman:1986ux}).
