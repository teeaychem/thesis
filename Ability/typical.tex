...
\begin{note}
  \autoref{idea:tR-law} (\autopageref{idea:tR-law}), \tCV{2} only if a law is true.

  The purpose of this section is to link \autoref{idea:tR-law} to \fc{1}.
...
\begin{note}
  ...
  However, the collection may be understood as collections of \tI{1} of the narrower type `multiplication by powers with respect to problems \ref{mfp:a}--\ref{mfp:h}'.
  In this respect, additional \prop{0}-\val{0}-\pool{0} pairs covering problems \ref{mfp:e} to \ref{mfp:h} may be included.

  And, the collection may be understood as collections of \tI{1} of the narrower type `multiplication by powers with respect to problems \ref{mfp:a}--\ref{mfp:d}'.
...
\begin{note}
  Difficulty.
  As extension, no way to distinguish between twr \torN{1} with the same extension.
  However, may distinguish between `quss' and `plus' (\autoref{illu:quus}, \autopageref{illu:quus}).
\end{note}
