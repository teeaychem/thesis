...
\begin{note}
  \begin{scenario}[Powerful multiplication]%
    ...
    \end{quote}
    %
    The student starts work on exercise~\ref{mfp:f}, and is concluding \pv{\propM{n}\propI{ is }\propM{200}}{\valI{True}}.
  \end{scenario}
...
\begin{note}
  ...
  And, as a result, our argument for the failure of \issueConstraint{} will primarily turn on whether there are \scen{1} in which an agent is \tCV{} (as understood by \autoref{idea:tC}).
\end{note}
