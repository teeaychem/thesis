...
\begin{note}[Evidence of evidence]
  ...
  \citeauthor{Tal:2017uw} disambiguate \emph{de re} and \emph{de dicto} readings.

  Distinguish between two instances of EEE.
  ...
  \begin{quote}
    For all e, e ′ and p, if (i) e is evidence for e ′ and (ii) e ′ is evidence for p, then e is evidence for p.
  \end{quote}
