...
\begin{note}
  ...
  \begin{restatable}[Witness]{issue}{issueWitness}
...
\begin{note}
  ...
  \begin{restatable}[Relations between resolutions to issues~\ref{issue:why-inc-in-how} and~\ref{issue:has-witnessed}]{proposition}{propIssueRelation}
    \label{prop:IssueRelation}
    A negative resolution to~\autoref{issue:has-witnessed} entails a negative resolution to~\autoref{issue:why-inc-in-how}.

    However, a negative resolution to~\autoref{issue:why-inc-in-how} does not entail a negative resolution to~\autoref{issue:has-witnessed}.
    \begin{argument}
...
\begin{note}
  ...
  Inclusion entails witness.
  For, how, witnessed, etc.
  Not conversely.
  Past reasoning.
  For example, look through a diary.

  Consider cases with reasoning.
...
\begin{note}[Pre-theoretical constraint]
  No account of why without an account of how.
...
\begin{note}
  Here, idea of a \fc{0}.
  Basics of the idea is that X is a \fc{0} just in case would not fail to conclude X.

  In this respect, X supports Y, given epistemic state.
