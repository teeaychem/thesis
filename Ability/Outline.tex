...
\begin{note}[Simple negative resolutions]
...
\begin{figure}[h]
  ...
  \begin{tikzpicture}
    ...
    \end{tikzpicture}
    \caption{Sketch of when an agent has a positive resolution for~\autoref{question:zs}.}
...
\begin{note}
  ...
  \Autoref{prop:qzs-tick-equals-iCS:var} states that an agent satisfying \iZs{} is a necessary condition of the agent satisfying an property \(\chi\) which is sufficient to ensure a positive resolution to~\autoref{question:zs}.
