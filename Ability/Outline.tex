...
\begin{note}
  Argue against positive resolution to \autoref{issue:why-inc-in-how}.
...
\begin{note}
  \autoref{sec:qWhy:refined} refined \qWhy{} in terms of support.
  \autoref{sec:qHow:refined} refined, or perhaps weakened, \qHow{} in terms of witnessing.
  ...
  Purpose of the present section is to bring refinements to questions together to provide refinement to~\autoref{issue:why-inc-in-how}.
...
\begin{note}
  \begin{proposition}
    ...
    Grating a positive resolution to~\autoref{issue:why-inc-in-how}, and given \autoref{assu:why:support:pvpp} and \autoref{idea:how-witnessing}:
    \begin{itemize}
    \item
...
\begin{figure}[H]
  \centering
  \begin{tikzpicture}
    \node[draw, text width=.45\textwidth] (whyO) at (0,0) %
    {\qWhyV{} is answered by support between \(\pv{\psi}{v'}\) and \(\Psi\).};
    %
    \node[draw, text width=.45\textwidth] (whyA) at (2,-1.5) %
    {\qWhy{} is answered by \(\pvp{\psi}{v'}{\Psi}\).};
    %
    \node[draw, text width=.45\textwidth] (howA) at (4,-3) %
    {\qHow{} is answered by \(\pvp{\psi}{v'}{\Psi}\).};
    %
    \node[draw, text width=.45\textwidth] (witA) at (6,-4.5) %
    ...
    %
    \node[text width=.5\textwidth] (2) at (3,-2.25) %
    {Via a positive resolution to \autoref{issue:why-inc-in-how}.};
    %
    \node[text width=.5\textwidth] (3) at (5,-3.625) %
    {Via \autoref{idea:how-witnessing}.};
  \end{tikzpicture}%
  \caption{Relation between why and hows.}
...
\begin{note}
  Converse, then either reject ideas or negative resolution to \autoref{issue:why-inc-in-how}.
\end{note}
...
\begin{note}
  ...
  Argue this type of \scen{0} motivates negative resolution to~\autoref{issue:has-witnessed}, and, by extension,~\autoref{issue:why-inc-in-how}.
