...
\begin{note}
  ...
  To aid the clarify of the argument we begin by introducing a plausible candidate \(\chi\).
...
\begin{note}[Key idea]
  Before turning to the details of the argument, it may be helpful to briefly state the core idea which we will press.
