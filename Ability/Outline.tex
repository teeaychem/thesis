...
\begin{note}
  ...
  \begin{restatable}[\(\times\) and \(\div\)]{scenario}{scenarioClacMulDiv}
    ...
    \begin{quote}
      \(23 \times 15 = 345\) \emph{only if} \(345 \div 15 = 23\).
    \end{quote}
...
\paragraph{Maybe inductive reasoning}
...
\begin{note}
  ...
  \begin{restatable}[\zSN{2}]{question}{questionZS}
    ...
    \begin{enumerate}[label=\arabic*., ref=(\arabic*)]
    \item
      Is there some proposition-value-premises pairing \(\pvp{\psi}{v'}{\Psi}\) such that:
      \begin{itemize}
      \item
...
\subsubsection[Visualisation]{Visualisation of what is at issue when asking \qzS{}}
...
\subsection{Equivalence between \qzS{} and \izS{}}
...
\label{sec:overview:issue-refined}
