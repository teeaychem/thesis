...
\begin{note}
  \begin{scenario}[Multiplication]
    ...
    Still, prior to concluding \(23 \times 15 = 345\), the agent observed that \emph{if} \(23 \times 15 = 345\), then they would also be able to observe this via their understanding of arithmetic.
  \end{scenario}
  ...
  Of course, and as noted by the agent, the agent may have a good understanding of arithmetic and could have calculated \(23 \times 15 = 345\) without the aid of the calculator.
  ...
  The agent may have concluded \(23 \times 15 = 345\) via their understanding of arithmetic, but so long as the agent did not calculate \(23 \times 15\) themselves, they did not conclude \(23 \times 15 = 345\) from whatever premises would be involved when reasoning via their understanding of arithmetic.
\end{note}

\begin{note}[Not just concluding]
  Still, intuitions about what is involved in an agent concluding some proposition-value pair from some pool of premises may be confused.

  For, concluding is something an agent does, and there are (at least) two distinct questions these intuitions may answer:
...
\begin{note}
  How? and why? are distinct questions, and in principle answers may differ.
...
\begin{note}
  Still, I suspect the response is roughly the same to both.
  Re-express \emph{how} and \emph{why} in terms of premises and conclusions, respectively:

  \begin{itemize}
  \item
    What premises were used in order to conclude \(\phi\) has value \(v\)?
  \item
    Which premises were appealed to in order to conclude \(\phi\) has value \(v\)?
  \end{itemize}

  Response is roughly the same to both.
...
\begin{note}
  ...
  In this respect, the agent's understanding of arithmetic is an equally good.

  In addition, there is an intuitive sense in which prior to entering \(23 \times 15\) into a calculator the agent knew \emph{whether} \(23 \times 15 = 345\).
