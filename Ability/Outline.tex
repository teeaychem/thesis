...
\begin{note}[Not just concluding]
  ...
  \begin{restatable}[\qWhy{}]{question}{questionWhyBasic}
    \label{q:why}
    Which proposition-value-premises pairings explain \emph{why} the agent concluded \(\phi\) has value \(v\)?
  \end{restatable}

  \begin{restatable}[\qHow{}]{question}{questionHowBasic}
    \label{q:how}
    Which proposition-value-premises pairings explain \emph{how} the agent concluded \(\phi\) has value \(v\)?
  \end{restatable}
...
\begin{note}
  ...
  \begin{restatable}[Inclusion]{issue}{issueInclusionFirst}
    \label{issue:how-why-relation-first}
...
\begin{note}
  ...
  Goal is to refine understanding of these questions.
...
\paragraph{Variant on `why'}

\begin{note}[\qWhy{}, refined]
...
\begin{note}
  Note, \autoref{issue:how-why-relation-first} was carefully stated.
  Recall:
  \begin{quote}
    \issueInclusionFirst*
  \end{quote}
  ...
  \autoref{issue:how-why-relation-first} does not state that \emph{something} is, in part, an answer to `why?' only if that something is, in part, an answer to `how?'.
...
\begin{note}
  ...
  \begin{question}[\qHowV{}]
    ...
    \textbf{Which proposition-value-premises pairings were part of the agent's reasoning?}
  \end{question}
...
\subsection{Issue}
\label{sec:issue-refined-proper}
