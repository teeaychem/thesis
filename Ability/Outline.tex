...
\begin{note}[Shifting]
  Started with \illu{1}~\ref{illu:gist:calc} and \ref{illu:gist:sudoku}.
  ...
  Return to cases similar \illu{1}~\ref{illu:gist:calc} and \ref{illu:gist:sudoku} to later, and highlight connexion.
\end{note}
...
\begin{note}[New \illu{0}]
  ...
  Intuitively, if the agent were to \emph{conclude} the construction is a proof of \(A\), the agent would also, at the same time, conclude \(A\) is true given an arbitrary valuation.
