...
\begin{note}
  ...
  Have the idea of a \fc{0}, and so of X supporting Y.
  However, this doesn't show that this is involved in why.

  Indeed, \fc{0} from understanding of arithmetic.
  But, it is not obvious that this is why.
  Calculator does it all.

  Sum from calculator if and only if sum from understanding.
  Particular kind of support, \zS{}.
\end{note}
...
\begin{note}
  ...
  \begin{restatable}[Does concluding require witnessing]{issue}{issueMain}
    \label{issue:Main}
