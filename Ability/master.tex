...
\include{AbilityClaimingSupport}

\part{Reasoning}
\label{part:reasoning}

\include{AbilityReasoning0Introduction}

\include{AbilityReasoning1TwoTypes}

\include{AbilityReasoning2Literature}
...
\include{AbilityTensionA}

\include{AbilityTensionB}

\include{AbilityTensionEstablished}
...
\part{Tension I}
\label{part:planForTension}

\include{AbilityConflictingIdeas}

\include{AbilityPlanForTension}

\part{Claiming support II}
\label{part:claimingSupportII}

\include{AbilityAbility}

\include{AbilityTwoTypesOfReasoning}

\part{Supplements}
\label{part:supplements}

\include{AbilitySupplement}
