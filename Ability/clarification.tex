...
\begin{note}
  ...
  However, \evalN{} are coarser than propositional attitudes.
...
\begin{note}
  ...
  \footnote{
    ...
    For, the agent may have failed to grasp the Archimedean property does not hold for real numbers, and may think that, though \(0.999\dots\) approaches \(1\), there must be \emph{some} difference between \(0.999\dots\) and \(1\) --- no matter how small --- and some difference between to things is sufficient to establish that they are not equal.
  }
\end{note}
...
\begin{note}
  ...
  Emphasis may be placed on `\evalN{}' --- as, e.g., Prospero's epilogue was the conclusion of the play --- or `the result of some process' --- as, e.g., some evaluations may be innate.
\end{note}
...
\begin{note}
  ...
  \begin{definition}[\pool{3}]
    ...
    %   \begin{itemize}
    %   \item
    %     For every \(\pv{\phi}{v}\) in \pool{}, \vAgent{} has \evaled{0} \(\phi\) as having value \(v\).
    %   \end{itemize}
    \end{itemize}
    \vspace{-\baselineskip}
  \end{definition}
