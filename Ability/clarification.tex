...
\begin{note}
  ...
  Still, we make a pair of observations to highlight.
...
\begin{note}
  ...
  Some kind of summary of what is going on?
\end{note}
...
\begin{note}
  We have covered the basics of an event in which an agent is concluding.
  However, with the details fresh we briefly define a term which builds on our understanding of an event in which an agent is concluding.
