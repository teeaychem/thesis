...
\begin{note}
  ...
  In this respect, we make speak in terms of \evalN{1} rather than conclusions.
  However, one key difference.
  \evalN{1} does not distinguish an event.
  Conclusion does.

  However, before turning to events, \pool{1}.
\end{note}
...
\begin{note}
  ...
  The event is not limited to the agent \evaling{} \(\phi\) with value \(v\), but includes how the agent comes to \eval{0} \(\phi\) by \(v\).
\end{note}
