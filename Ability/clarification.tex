...
\begin{note}
  ...
  \begin{definition}[\sR{2}{reasoning}]
    \label{def:cmptnc}
    The reasoning of \(e\) is \emph{\sR{0}{reasoning}}, just in case, instance of a type of reasoning.
  \end{definition}
...
\begin{note}
  ...
  However, \sR{}{reasoning} does not require rule following.
  Rather, \sR{}{reasoning} only requires the rough phenomenon that \citeauthor{Boghossian:2008vf} argues rule following is the only plausible explanation of.
\end{note}
...
\begin{note}
  ...
  Whatever the generality of \sR{0}{reasoning} on our understanding, it may fail for arbitrary pairs.
  No guarantees about idealisation.
  Still, general.
  Many instance of multiplying, and, when multiplying, reasoning is, typically, at least, \sR{}{reasoning}.
\end{note}

\begin{note}
  Primary upshot is that \sR{}{reasoning} does not depend on resolutions to rule following paradox.

  To illustrate.
  Strictly, \sR{}{reasoning} does not depend on addition.
  Compatible that \sR{}{reasoning} is smaddition(?)
...
\begin{note}
  \sR{}{reasoning} is compatible with dispositionalism.
