...
\begin{note}
  ...
  Given~\autoref{assu:ConRea}, the event in which the agent concludes includes the the agent's application of \emph{modus ponens}.

  However, we have little interest in what reasoning amounts to.%
  \footnote{
    As highlighted in \autoref{cha:intro}, our interest is with relations between conclusions and \pool{}.
  }
