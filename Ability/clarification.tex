...
\begin{note}
  ...
  Following an example of \citeauthor{Williams:1979wi}, \propI{The stuff is gin} may be \eval{} \valI{True} though the stuff really is petrol (\citeyear[18]{Williams:1979wi}).%
  \footnote{
...
\begin{note}
  ...
  Likewise, \citeauthor{Boghossian:2014aa}.
  ...
  And, \citeauthor{Longino:1978wv}'s (\citeyear{Longino:1978wv}) account of inferring:
  \begin{quote}
  ...
  Similar, \textcite{Wedgwood:2006ui} and normative facts.
  Affects the characterisation of the relevant \pool{}.

  Same for \textcite{Thomson:1965vv}, where \pool{} involves a belief that other elements of \pool{} are a reason for evaluating \(\phi\) with value \(v\).
