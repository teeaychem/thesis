...
\begin{note}
  In~\autoref{cha:introduction} we considered an instance of concluding, raised two questions --- \qWhy{} and \qHow{} --- and stated an issue --- \issueInclusion{} --- with respect to these questions.
...
\paragraph{Proposition-value pairs}
...
\begin{note}
  ...
  \begin{notation}[Proposition-value pairings]
    We will make use of the following notation:
    \begin{itemize}
    \item
      Lower case letters of the Greek alphabet, \(\phi, \psi, \dots\), refer to propositions.
    \item
      The Latin letter \(v\) refers to a value.
      Generally, \(v\) may be read as `true'.
      In cases where more than one value may be relevant we will write \(v', v'' \dots\).
      However, \(v, v'\), and \(v''\) may all refer to the same value.
    \item
      ...
      \end{itemize}
    \item
      Upper case letters of the Greek alphabet, \(\Phi, \Psi, \dots\), refer to collections of proposition-value pairings.
...
\begin{note}
  ...
  \begin{quote}
    \begin{fitch}
      \ftag{\scriptsize i}{\fa \fh \alpha} & \\
      \ftag{\scriptsize }{\fa \fa \vdots} & \\
      \ftag{\scriptsize j}{\fa \fa \beta} & \\
      \ftag{\scriptsize j+1}{\fa \alpha \rightarrow \beta} & \(\rightarrow\)\textbf{Intro:} \emph{i}--\emph{j} \\
    \end{fitch}
  \end{quote}
...
\end{quote}
  ...
  Here capture in terms of relation between proposition-value pairings.
  Pool of premises and conclusion.
  Truth or desirability is premise, rather than belief or desire.%
  \footnote{
    In cases where these matter, attitude is captured by truth of proposition.
  }
  Hence, relevant characterisation of belief and desire will be set aside.%
  \footnote{
    No clear distinction between knowledge and belief in terms of valuations.
    But, difference won't be important.
  }
  And, instead, propositions and values.
  When concluding, how agent evaluates proposition, rather than general attitude.%
  \footnote{
    Note, in particular, no clear distinction between knowledge and belief.
  }
