  ...
  \begin{restatable}[\qWhyV{}]{question}{questionWhyV}
    ...
    \begin{quote}
      ...
      \item[\emph{If}:]
        ...
        \item
          \support{2} failed to hold between \(\pv{\psi}{v'}\) and \(\Psi\) when pairing \(\phi\) with \(v\)(, from the agent's perspective).
        \end{enumerate}
      \item[\emph{Then}:]
        \begin{enumerate}[label=\alph*., ref=(\alph*), resume*=qWhyVDef]
        \item
...
\begin{note}
  ...
  However, a prior to considering whether embeds, candidate \ros{1} via dependence.
\end{note}
