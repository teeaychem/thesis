...
\begin{note}
  ...
  \item
    ...
    \sR{}{reasoning}, in additional detail.
  \end{itemize}
\end{note}
...
\begin{note}
  For example, an agent has \ninf{0} over whether or not they are going to buy some apples.
...
\begin{note}
  The motivation for the conditional rests on whether reasoning is \sR{}{reasoning}.
  ...
  However, is it the case that \sR{}{reasoning}?
  For, I may not be thinking straight.
  If I have just woken up after a few hours sleep \dots

  If not \sR{}{reasoning}, then it is not clear to me what reasoning amounts to.
  I have a what might be a syntactic proof.
  However, the apparent proof may just be an association of thoughts.

  Hence, any doubt that reasoning is \sR{0}{reasoning} would lead to abandoning concluding.
  ...
  If would not stop, then not \sR{}{reasoning}.

  Do not conclude if reasoning is not \sR{}{reasoning}.

  Where, \sR{}{reasoning} then some general type of reasoning of which token.
...
\begin{note}
  ...
  However, regardless of \agpe{my}, then if \requ{} fails to hold, it is unclear whether reasoning is \sR{}{reasoning}.
  ...
  If \agpe{my} is wrong, then it is the case that reasoning is not \sR{}{reasoning}.
  Conclude only if \sR{}{reasoning}.
\end{note}
...
\begin{note}
  ...
  As with lost keys, \requ{} need not be tied to \sR{}{reasoning}.
  With lost keys, \sR{}{reasoning}, but whether that is sufficient for concluding.

  Motivation for \requ{1} and concluding rests on \sR{}{reasoning}, but is plausibly broader.
\end{note}

\begin{note}
  Keep in mind distinction.
  Concluding, versus concluding via \sR{0}{reasoning}.
  It need not be the case that if not \sR{0}{reasoning} then not concluding.
...
\begin{note}
  ...
  Well, in terms of \sR{}{reasoning}.
  Don't need \sR{}{reasoning}.
  Novel results, and so on.

  And, with guidance, removed the need for \sR{}{reasoning} with respect to overall.
\end{note}
...
\begin{note}
  So, know whether or not present reasoning is \sR{}{reasoning}.
