...
\begin{note}
  We start with an \illu{0} of a \requ{0} in which an agent is not concluding.

  Then, \illu{0} of a \requ{0} in which an agent is concluding.
\end{note}
...
\begin{note}
  ...
  \begin{proposition}
    ...
    The existence of \requ{1} does not presuppose counterexamples to \issueConstraint{}.
  \end{proposition}
...
\section{\requ{3}, competence, performance}
...
\begin{note}
  ...
  If both of these things hold, then plausible \requ{1} exist.
...
\begin{note}
  ...
  We will scrutinise to both worries in \autoref{cha:know}, after establishing how \requ{1} lead to counterexamples to \issueConstraint{}.
