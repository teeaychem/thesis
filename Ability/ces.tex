...
\begin{note}
  Given  we have an event \(\edn{\flat}\) under description \(\edo{\flat}\) in which you concluded \pv{\propI{The value of the centre cell of the left puzzle is 8}}{\valI{True}} from \(\Phi\) with the aim of solving the left Sudoku puzzle.
  Further:
  %
  \begin{itemize}
  \item
  ...
  \item
    When \(\ed{}\) happened, \(\ed{}\) happened party as a result of \(\ed{\flat}\) --- you concluded each cell in the left Sudoku grid is correct from \(\Phi\) party as a result of concluding \pv{\propI{The value of the centre cell of the left puzzle is 8}}{\valI{True}} from \(\Phi\).
  \end{itemize}
  %
...
\begin{note}
  So, to show a \ros{} between \pv{\propI{The value of the centre cell of the right puzzle is 4}}{\valI{True}} and \(\Phi\) from \agpe{your} answers \qWhy{}, we need to show \(\edo{\flat}\) entails a \ros{} between \pv{\propI{The value of the centre cell of the right puzzle is 4}}{\valI{True}} and \(\Phi\) holds from \agpe{your}.
\end{note}
...
\begin{note}
  So, to show a \ros{} between \pv{\propI{The value of the centre cell of the right puzzle is 4}}{\valI{True}} and \(\Phi\) from \agpe{your} answers \qWhy{}, it is sufficient to show \(\edo{\flat}\) entails \pv{\propI{The value of the centre cell of the right puzzle is 4}}{\valI{True}} was a \fc{} from \(\Phi\) for you.%
  \footnote{
...
\begin{note}
  \color{blue}
  To obtain \fc{1} in a general way, \autoref{cha:typical} introduced the idea of an agent \tCV{} by a \torN{} and a \tprof{}.
  ...
  In short, in the same way it makes no sense to describe an agent as concluding by factorisation if it is not possible for the agent to factor structurally similar quadratic equation, it made no sense to describe you as concluding by your understanding of Sudoku if it was not possible for you conclude \pv{\propI{The value of the centre cell of the right puzzle is 4}}{\valI{True}} from \(\Phi\).

  In this respect, \(\edo{\flat}\) entails \pv{\propI{The value of the centre cell of the right puzzle is 4}}{\valI{True}} was a \fc{} from \(\Phi\) for you.
\end{note}
...
\begin{note}
  So, a description of an event in which \pv{\propI{The value of the centre cell of the left puzzle is 8}}{\valI{True}} `follows from' \(\Phi\) from \agpe{your} such that event results in your \pv{\propI{The value of the centre cell of the left puzzle is 8}}{\valI{True}} from \(\Phi\) answer \qWhy{}.


  \pv{\propI{The value of the centre cell of the right puzzle is 4}}{\valI{True}} `following from' \(\Phi\) is part of what it is for \pv{\propI{The value of the centre cell of the left puzzle is 8}}{\valI{True}} `following from' \(\Phi\).
\end{note}
