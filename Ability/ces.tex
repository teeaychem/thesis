...
\begin{note}
  ...
  \item
    ...
    Hence, by Clause~\ref{assu:p:se:prog} of the definition of a \se{} (\autoref{def:se}, \autopageref{def:se}), \(\ed{\flat}\) is such that \(\eXd{}\) is in progress.
...
\begin{note}
  ...
  \item
    ...
    Find an \eiw[\(\edn{\flat}\) under description \(\edo{\flat}\)]{0} \(\eXd{}\) is in progress and for which \(\ed{}\) (partly) happens as a result of.
