...
\begin{note}
  With \autoref{prop:tCV-WhyV-ces} in hand, our final task is to show there are \scen{0} where conditions \ref{prop:hinge:X:tCed}, \ref{prop:hinge:X:e:act:se}, \ref{prop:hinge:X:tC}, \ref{prop:hinge:X:e:pro} and \ref{prop:hinge:X:e:pro:fc} hold.
\end{note}
