...
\begin{note}
  ...
  \item
    ...
    And, as \(\Phi\) captures the \agents{} understanding of factorisation, \autoref{prop:p-t} entails \(\edo{\flat}\) is an \eiw{0} the agent is \tCV{} \pv{\propM{\rootsCon{}}}{\valI{True}} from \(\Phi\) by factorisation.
  \end{enumerate}
