...
\begin{note}
  ...
  \begin{notationList}
  \item
    Specific \prop{1} and \val{1} are written in a \textsf{sans-serif} font.
...
\subsection{Conclusions, concludes, concluding}
\label{sec:concl-events-which}

\begin{note}
  Conclusions understood in terms of \evalN{1}:
...
\begin{note}
  ...
  \begin{definition}[Events in which an agent concludes]
    ...
    \begin{itemize}
    \item
      \(e_{d}\) is an event in which \vAgent{} \emph{concludes} \(\pv{\phi}{v}\).
    \end{itemize}
    %
    \emph{If and only if}:
    %
    \begin{itemize}
    \item
      \(e_{d}\) includes an event in which \vAgent{} \evals{} \(\phi\) to have \val{} \(v\).
    \end{itemize}
    \vspace{-\baselineskip}
  \end{definition}
\end{note}
...
\begin{note}
  ...
  \begin{definition}[Events in which an agent is concluding]
    ...
    \begin{itemize}
    \item
      \(e_{d}\) is an event in which an agent is \emph{concluding} \(\pv{\phi}{v}\) if \(e_{d}\) is an event such that an event \(e'\) in which the agent concludes \(\pv{\phi}{v}\) is in progress.
    \end{itemize}
    \vspace{-\baselineskip}
  \end{definition}
  ...
  Hence, \textquote{the agent is concluding \(\phi\) has \val{0} \(v\)} is read in parallel to a natural reading of \textquote{the agent is walking to the shops} or \textquote{the agent is filling a bathtub}.
\end{note}
...
\begin{note}
  ...
  \begin{observation}[Conclusions without concluding]%
    ...
    \item[\emph{Then}:]
      There is some \se{0} \(e^{\flat}_{d^{\flat}}\) of \(e_{d}\) in which \vAgent{} is concluding \(\pv{\phi}{v}\) from \(\Phi\).
    \end{itenum}
    \vspace{-\baselineskip}
  \end{observation}
...
\begin{note}
  ...
  \begin{assumption}[Conclusions by reasoning]
    ...
    \item[\emph{If}:]
      \(e_{d}\) is an event in which \vAgent{} concludes \(\pv{\phi}{v}\) from \(\Phi\).
    \item[\emph{Then}:]
      \(e_{d}\) is an event in which \vAgent{} \emph{reasons} to \(\pv{\phi}{v}\) from \(\Phi\).
    \end{itenum}
    \vspace{-\baselineskip}
  \end{assumption}
...
\begin{note}
  ...
  In our terminology, evaluation \emph{p} has \val{0} \valI{True}.
  From belief \emph{q}, \pool{} which contains \pv{q}{\valI{True}}.
\end{note}
