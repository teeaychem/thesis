...
\begin{note}
  ...
  In many cases, a \pool{}, or an collection of \evalN{} which form the basis of a \pool{} are clearly associated with a conclusion.
\end{note}
...
\begin{note}
  In short, \autoref{assu:ConRea} fixes the \emph{scope} of an event in which an agent concludes to span the event in which the agent reasons to the conclusion \(\phi\) has \val{0} \(v\) from the \pool{} \(\Phi\).
