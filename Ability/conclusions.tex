...
\begin{note}
  ...
  \begin{assumption}[Conclusions by reasoning]
    ...
    \item[\emph{If}:]
      ...
      \item
        ...
        There is some \se{} \(\ed{\flat}\) such that \(\ed{\flat}\) \vAgent{} is concluding \(\pv{\phi}{v}\) from \(\Phi\)
      \end{enumerate}
    \item[\emph{Then}:]
  ...
  In this case, the relevant \pool{} may plausible be empty and no reasoning takes place, and hence Clause~\ref{assu:ConRea:prog} ensures we do not assume reasoning took place.%
  \footnote{
    Though see \textcite{Siegel:2017aa} for counterpoint.
  }
\end{note}
