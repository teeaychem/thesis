...
\begin{note}
  ...
  So, the issue is about whether the agent's reasoning is `robust' with respect to \epAdv{} \world{1}.
  And I don't see a clear distinction between candidates for actual \world{} and \epAdv{} \world{1} in this respect.
...
\begin{note}
  ...
  And, if not strictly necessary, I see \ideaCSA{} as capturing a plausible general account of an attitude that is responsive to entertaining such \ep{1}.
\end{note}
