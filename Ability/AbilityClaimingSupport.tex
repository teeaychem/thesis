...
\begin{note}
  \begin{restatable}[\result{3} of a step of reasoning]{definition}{defResult}
    \label{def:result}
    ...
    \begin{enumerate}
    \item\label{def:requi:prop} \(\psi\) having value \(v'\):
      \begin{enumerate}
      \item\label{def:requi:prop:conseq} Follows as a result of making the step of reasoning.
      \item\label{def:requi:prop:persists} Persists through to the conclusion of the instance of reasoning.
      \end{enumerate}
  ...
  \begin{restatable}[\prequ{2} of a step of reasoning]{definition}{defRequisiteP}
    ...
    \(\psi\) has value \(v'\) is a \emph{\result{0}} of a step of reasoning if and only if
    \begin{enumerate}
  ...
  \begin{restatable}[\cprequ{2} of a step of reasoning]{definition}{defRequisiteCP}
    ...
    \(\psi\) has value \(v'\) is a \emph{\cprequ{0}} of a step of reasoning if and only if
    \begin{enumerate}
    \item \(\xi\) has value \(v''\) is a \crequ{0} of a that step of reasoning.
    \item \(\xi\) having value \(v''\) then \(\psi\) has value \(v'\) is a \prequ{} of the step of reasoning.
    \end{enumerate}
    \vspace{-\baselineskip}
  \end{restatable}

  This then keeps going.
  For our purposes, this is enough.
  However, general definition of a \requ{}.
...
\begin{note}
  ...
  Distinguish between the two ways in which some proposition-value may be a \requ{}.
  And, terminology for an agent's thought's about a \requ{}.
\end{note}

\paragraph{Sub-definitions}

\begin{note}
  Before moving on, it will be helpful in further discussion to distinguish between the two ways in which some proposition-value may be a \requ{}.
\end{note}



\paragraph{Being \mistaken{} or \misled{}}
