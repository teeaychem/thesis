...
\begin{note}[Wally]
  \begin{illustration}[Where's Wally]
    ...
    %   \setcounter{enumi}{-1}
    % \item\label{illu:CS:wheres-wally:info} The individual identified is Wally only if the individual is wearing a pair of round glasses.
    % \end{enumerate}
    %
    ...
    %   Had features.
    %   % \item The individual identified is Wally only if the individual is wearing a pair of round glasses.
    % \item
    %   The individual was wearing a pair of round glasses. \hfill (From \ref{illu:CS:wheres-wally:info} and \ref{illu:CS:wheres-wally:ante})
    % \end{enumerate}
  \end{illustration}
  ...
  So, specifically, our interest is in whether \nagent{15} would claim support that the character is Wally from the variety of features identified.
  And, the difficulty for \nagent{15} is that there an clear check on whether \nagent{15} may reason to a different conclusion.
  ...
  Of course, it may also be that the character is wearing a pair of round glasses.
  At issue, though, is that \nagent{15} considers it \epVAd{} that the character is not wearing a pair of round glasses --- \nagent{15} only recalls the features they appealed to.
\end{note}
