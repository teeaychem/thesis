  ...
  \begin{restatable}[A \requ{0}]{notion}{ideaRequisite}
    ...
    \item \vAgent{} is committed to it being the case that if \(\psi\) does not have value \(v'\) then either:
      ...
      \item
        ...
        If \(\psi\) does not have value \(v'\) then (\(\delta\) does not allow to conclude \(\phi\) from \(\chi\)).
        % \newline
        % \mbox{}\hfill(`\(\psi\) having value \(v'\) is a \crequ{}')
      \end{enumerate}

      \begin{enumerate}
      \item
        \(\psi\) having value \(v'\) follows from \(\phi\) having value \(v\).
      \item
        If \(\phi\) has value \(v\), then it is `possible' to conclude that \(\psi\) has value \(v'\) without \(\delta\).
      \item
        \(\psi\) having value \(v'\) is weaker than \(\phi\) having value \(v\) (with respect to what is\epPAd{}).
      \end{enumerate}
    \end{enumerate}
    \color{red}
...
\subparagraph{Contrast: Testimony}
