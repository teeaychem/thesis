...
\begin{note}
  ...
  So, \nIBackground{} are to ensure that \(\psi\) having value \(v'\) is an expectation of the claimed support for \(\phi\) having value \(v\).
  ...
  Block reasoning of \ref{nI:going-by-value}.
\end{note}
