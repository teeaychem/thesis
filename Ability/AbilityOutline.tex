...
\begin{note}
  ...
  \begin{restatable}[\eiS{-} --- \eiS{}]{assumption}{eisProp}\label{assu:supp:independence}
  ...
  One assumption:
  \begin{assumption}\label{assu:appeal-to-previous-CS}
...
\begin{note}
  ...
  \begin{proposition}\label{prop:CS-only-if-reason-recognised-defeaters}
    If recognised defeater and does not reason, not an instance of claiming support.
  \end{proposition}
\end{note}
...
\begin{note}
  ...
  {
    \color{red}
    This follows from requirement that there is some reasoning.
  }
...
\subsection{\autoref{assu:expect-nai}}
\label{sec:refl-claim-supp}

\subsubsection{Strength}

\begin{note}[Interesting case for \autoref{assu:expect-nai}]
...
\begin{note}
  ...
  Again, seeing what \autoref{assu:expect-nai} does.
...
\begin{note}[Focus]
  ...
  \begin{restatable}[\ESU{-} --- \ESU{}]{target}{idea_ESU}\label{denied-claim}
  ...
  \begin{restatable}[\gESU{}]{target}{idea_gESU}\label{denied-claim}
...
\begin{note}[Alternative]
  ...
  \begin{restatable}[\EAS{-} --- \EAS{}]{goal}{goal_EAS}\label{prop:EAS}
...
\begin{note}[\EASw{}]
    \begin{restatable}[\EASw{-} --- \EASw{}]{idea}{idea_EASw}\label{prop:EASw}
...
\begin{note}[\nI{}]
  \begin{proposition}[\nI{-}  --- \nI{}]\label{prem:ni}
    ...
    \item {\color{red} \(\psi\) is expectation of claimed support for \(\phi\) having value \(v\).}
    \end{enumerate}
    And, suppose:
