...
\begin{note}[Plan]
  ...
  \item Contrast with related distinctions.
  \item Apply to ability.
  \end{itemize}
\end{note}
...
\begin{note}[]
  \begin{illustration}\label{ill:rectangle:ur}
    \vspace{-\baselineskip}
    \begin{enumerate}[label=\(\protect\tBox\)\space\arabic*., ref=\arabic*, align=left, leftmargin=*]
    \item\label{tB:measure} This rectangle measures \(19\text{cm}\) by \(7\text{cm}\).
    ...
    \item\label{tB:conclusion} Hence, the area of this rectangle is \(133\text{cm}^{2}\).
    \end{enumerate}
    \vspace{-\baselineskip}
  \end{illustration}
  ...
  Key is that at no point does the agent abstract from the particular rectangle to an arbitrary rectangle with the same dimensions --- (\(\tBox\)\space\ref{tB:width} -- \ref{tB:total}) are about the specific rectangle.
  Of course, the same reasoning may be applied to any rectangle with the same dimensions, but steps \(\tBox\)~\ref{tB:measure} to \ref{tB:conclusion} are about \emph{that} particular rectangle.
  ...
  \begin{illustration}\label{ill:rectangle:nr}
    \vspace{-\baselineskip}
    \begin{enumerate}[label=\(\protect\tBoxd\)\space\arabic*., ref=\arabic*, align=left, leftmargin=*]
    \item\label{tBd:measure} This rectangle measures \(19\text{cm}\) by \(7\text{cm}\).
    ...
    \item\label{tBd:conclusion} Hence, the area of this rectangle is \(133\text{cm}^{2}\).
    \end{enumerate}
    \vspace{-\baselineskip}
  \end{illustration}
  ...
  Key is that the agent abstracts from the particular rectangle to an arbitrary rectangle with the same dimensions for the most part of their reasoning --- (\(\tBoxd\)\space\ref{tBd:calculate} -- \ref{tBd:abstract}) are not about any specific rectangle.
...
\begin{note}
  ...
  Following, apply this distinction to additional illustrations which will resemble ability.
...
\begin{note}[\ur{} in some detail]
  \begin{definition}[\ur{}]
    When claimed support by appealing to proposition or part of proposition which may refer, the agent appeals to or uses the referent of the proposition or part.
  \end{definition}
...
\begin{note}[\nr{} in some detail]
  \begin{definition}[\nr{}]
    When claimed support by appealing to proposition or part of proposition which may refer, the agent does not appeal to or use the referent of the proposition or part.
  \end{definition}
...
\begin{note}
  ...
  Goal is to consider reasoning with existentials.
  This, then expanded on when turn to application of the distinction.

  Start by appling to reasoning with simple logical vocabulary.
  In this case, `and'.
...
\begin{note}[Instance of reasoning]
  ...
  \begin{itemize}
  \item The dog is \RIPa{} and \RIPb{}.
  \item So, The dog is \RIPa{} and the dog is \RIPb{}.
  \item Hence, the dog is \RIPb{}.
  \end{itemize}

  Two adjectives, `\RIPa{}' and `\RIPb{}' are put together and predicated of something, `the dog'.
  So, take this apart.\nolinebreak
  \footnote{
  ...
  \RIPa{-} and \RIPb{} breaks down in a certain way.

  First pair of illustrations look at breaking down the complex adjectives into simple adjectives.
\end{note}

\begin{note}[Example, \nr{}]
  Reasoning \emph{without} appeal to reference.
  \begin{illustration}
    \begin{enumerate}[label=\(\protect\iDog\)\arabic*.]
    \item \((\text{\RIPa{-} and \RIPb{}})(d)\)
    \item \(\forall x((\text{\RIPa{-} and \RIPb{}})(x) \leftrightarrow (\text{\RIPa{-}}(x) \land \text{\RIPb{-}}(x)))\)
    \item \((\text{\RIPa{-} and \RIPb{}})(d) \leftrightarrow (\text{\RIPa{-}}(x) \land \text{\RIPb{-}}(d))\)
    \item \(\text{\RIPa{-}}(d) \land \text{\RIPb{-}}(d)\)
    \item \(\text{\RIPb{-}}(d)\)
    \end{enumerate}
  \end{illustration}

  ;dghasdkjlfdslhfdsakjfhdsalkfdjfhasl
  
  Surrounding (\(\iDog\)) test
  ...
  It doesn't matter what `the dog', `\RIPa{}' and `\RIPb{}' refer to.
...
\begin{note}
  ...
  We're using first-order logic.
  In this respect, things follow from form alone.

  However, with respect to everyday reasoning, things may be more complex.
  For example, it may be important that \(d\) refers to a particular kind of thing, in order for a step of reasoning to be available.

  Consider going from this to there is something big.
  Well, that doesn't follow.
  

  The point, really, is that agent doesn't follow the reference.
\end{note}
...
\begin{note}[Example, \ur{}]
  ...
  Strikes the agent that the dog is \RIPa{} and \RIPb{}, and from this the agent goes to \RIPb{}.

  The dog is something with is \RIPa{} and \RIPb{}.
  \begin{itemize}
  \item \(\sem{The dog} \in \sem{\RIPa{-} and \RIPb{} dogs}\)
  \item \(\sem{\RIPa{-} and \RIPb{} dogs} = \sem{\RIPa{-} dogs} \cap \sem{\RIPb{-} dogs}\)
  \item \(\sem{The dog} \in \sem{\RIPa{-} dogs} \cap \sem{\RIPb{-} dogs}\)
  \item \(\sem{The dog} \in \sem{\RIPb{-} dogs}\)
  \end{itemize}
  ...
  Instead, the dog is \RIPa{} and \RIPb{}.
  So, reflection of how the agent's reasoning about the dog and \RIPa{} and \RIPb{}ness with respect to whatever it is that allows the agent to reason about the dog and \RIPa{} and \RIPb{}ness.

  The agent reasons about the dog and how it relates to \RIPa{} and \RIPb{}ness, and the \RIPb{}ness.
  \(\sem{\RIPa{-} and \RIPb{}} = \sem{\RIPa{-}} \cap \sem{\RIPb{-}}\) that \RIPa{} and \RIPb{}ness may be recast as \RIPa{}ness and \RIPb{}ness.
  \RIPa{-} and \RIPb{}ness is just the combination of two distinct qualities.

  We noted with respect to \nr{} that agent may establish rule from \RIPa{}ness and \RIPb{}ness.
...
\begin{note}[Example with an existential]
  ...
  \begin{itemize}
  \item \(\exists x(\text{\RIPa{-} and \RIPb{}})(x)\)
  \item \(\exists x((\text{\RIPa{-} and \RIPb{}})(x) \leftrightarrow \exists x(\text{\RIPa{-}}(x) \land \text{\RIPb{-}}(x)))\)
  \item \(\exists x(\text{\RIPa{-}}(x) \land \text{\RIPb{-}}(x))\)
  \item \(\exists x\text{\RIPb{-}}(x)\)
  \end{itemize}

  \begin{itemize}
  \item \(\sem{Some dog} \in \sem{\RIPa{-} and \RIPb{}}\)
  \item \(\sem{\RIPa{-} and \RIPb{}} = \sem{\RIPa{-}} \cap \sem{\RIPb{-}}\)
  \item \(\sem{Some dog} \in \sem{\RIPa{-}} \cap \sem{\RIPb{-}}\)
  \item \(\sem{Some dog} \in \sem{\RIPb{-}}\)
  \end{itemize}
...
\begin{note}
  ...
  \item the \aben.
  \end{itemize}
  Agent needs to go from general to specific.
  And, in turn from specific to \(\phi\).

  The key issue is this intermediary step.
\end{note}
...
\begin{note}[Use of terminology]
  ...
  For, \gsi{} and \aben{the} are fixed for the remainder of the major argument.
\end{note}
...
\begin{note}[Summary]
  ...
  In turn, if claimed support for specific ability, then any application of \aben{the} will be an instance of \AR{}.
  ...
  \aben{the} appeals to the potential witnessing event and so appeals to those resources.
\end{note}
...
\begin{note}[Expand: \aben{}]
  Conversely, with \aben{the} the agent claims support for \(\phi\).
  Similarly, claimed support, and \aben{the} takes (specific) ability to \emph{V} that \(\phi\) as main premise.
...
\begin{note}[Proposition]
  \begin{proposition}[\WR{} is incompatible with~\ESU{}]\label{mcA:WR-and-denied-claim}
    \emph{If} \ESU{} is true \emph{then} \WR{} is an incorrect interpretation of (specific) abilities of the form \emph{S} has the ability to \emph{V} that \(\phi\) (for which \aben{the} entailment holds).
    {
      \color{red}
...

  {
    ...
    No restrictions have been placed on \gsi{} move or \aben{the} move.
    ...
    For \aben{the}, the agent needs to witness specific ability in order to claim support for conclusion.
