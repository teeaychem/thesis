...
\begin{note}[Plan]
  ...
  \item Basic distinction.
  \item Illustrations.
  \item Develop illustrations.
...
\begin{note}[Reasoning]
  ...
  Some propositions, when part of reasoning, \emph{refer}.
...
\begin{note}[Example with a constant]
  ...
  \begin{illustration}
    ...
    The dog is \RIPa{} and \RIPb{}.
    So, The dog is \RIPa{} and the dog is \RIPb{}.
    Hence, the dog is \RIPb{}.
  \end{illustration}
  ...
  Logical is `and'.
  Non-logical is breaking down \RIPa{} and \RIPb{}.
\end{note}
