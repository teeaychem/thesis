...
\begin{note}
  ...
  Some reasoning about recognised and unrecognised \requ{0}.
...
\begin{note}
  Recall, \autoref{assu:CSVP}.
  Redescriptions of states of affairs count as expectations.
...
\begin{note}[Trivial testimony 1]
  \begin{illustration}[Trivial testimony 1]\label{illu:CS:test:basic}
    \mbox{}
...
\begin{note}[Trivial testimony 2]
  \begin{illustration}[Trivial testimony 2]\label{illu:CS:test:with-CS-for-premise}
    \mbox{}
    \begin{enumerate}[label=\arabic*., ref=(\arabic*)]
...
\begin{note}
  ...
  Yet, this does not hold with respect to self-attribution of trustworthiness.
\end{note}
...
\begin{note}
  ...
  Again, plausible.
  Still, assumes evidence against.
...
\begin{note}
  ...
  I do not have any insightful remarks to make.
  The purpose of the assumptions made is to narrow down a clearer problem.
  No reasoning, or clear impossibility of such reasoning.
...
\begin{note}[Spot the difference]
  \begin{illustration}[Spot the difference]\label{illu:cs:spot-the-diff}
    ...
    \item\label{illu:cs:spot-the-diff:fif} So, I have found fifteen differences.
    \end{enumerate}
  \end{illustration}
  ...
  Here, \requ{} and \expec{} of claimed support for \ref{illu:cs:spot-the-diff:all}.
  Simple for \requ{}.
...
\begin{note}
  \begin{illustration}[Where's Wally]
    ...
    \begin{itemize}
    \item Wally only if holding a cane.
    \end{itemize}
...
\begin{note}[Logic proof]
  Recall \autoref{illu:wheres-wally}.
...
\begin{note}[Zebra]
  This is complex.
  Yes if going by factivity.
  However, no if going by something weaker.
\end{note}
