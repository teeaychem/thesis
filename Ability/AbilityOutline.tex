...
\begin{note}[Use of conjecture]
  Two ways of understanding pianist.
  First, drinking the glass of wine is not a candidate resolution.
  Second, the agent has a stronger preference for the result of abstaining.

  Brief argument that \ESU{} requires the former to be the case and provide an example.
  Then, turn to \EAS{}, suggest that it allows the latter to be the case.
\end{note}
