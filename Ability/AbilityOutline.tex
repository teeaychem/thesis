...
\begin{note}[Brief illustration of \nI{}]
  ...
  \begin{illustration}
    Suppose an agent have constructed a theory of some general phenomenon.

    The theory seems to capture the phenomenon, and the agent has claimed (inductive) support that the theory is adequate by applying it to various instances of the general phenomenon.

    However, as the phenomenon is a \emph{general} phenomenon it also makes various predictions about what must happen in all other instances to which the agent has not (yet, at least) applied the theory to.

    Hence, there is a possible counterexample to the theory associated with each instance the agent has not (yet) applied the theory to.
  ...
  \(\phi\) the theory is adequate.
  \(\psi\) that there are no counterexamples.

  Now, given that the agent has claimed support that the theory is adequate, the agent may \emph{expect} that there are no counterexamples to the theory.
  However, it clear whether the agent may \emph{claim support} that there are no counterexamples to the theory.\nolinebreak
  \footnote{
    I'm not really sure.
  }
  Consider the type of reasoning captured by~\ref{nI:going-by-value}.

  Claimed support that the theory is adequate.
  So, there are no counterexamples.
  So, because claimed support adequate claim support that there are no counterexamples.
  ...
  So, relation between theory and counterexample undercuts using theory to get no counterexample.
  For, theory only works if no counterexample.
...
\begin{note}[Before continuing\dots]
...
\begin{note}[Plan]
  ...
  \item Overview \nI{}.
    ...
    \item Core idea.
    \item Intuition.
    \item Some relation to the literature.
    \end{enumerate}
  \item Detailed example.
  \item Details on each clause, with particular attention to~\ref{nI:inclusion} and~\ref{nI:going-by-value}
  \item Argument for \nI{}.
  \end{enumerate}
\end{note}
...
\begin{note}[More detail on clauses of \nI{}]
  ...
  And,~\ref{nI:going-by-value} expresses that the agent may not claim support for \(\psi\) having value \(v'\) by appeal to \(\phi\) having value \(v\).
...
\begin{note}[Idea main part of \nI{} works]
  ...
  Stronger than~\ref{nI:inclusion}: If you've claimed support for \(\psi\) then you've tacitly assumed that \(\psi\) has value \(v'\).
  ...
  So, what's to develop is why~\ref{nI:inclusion} does something similar.
\end{note}
