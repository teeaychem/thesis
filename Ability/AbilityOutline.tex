...
\begin{note}[\nI{}]
  \begin{proposition}[\nI{-}  --- \nI{}]\label{prem:ni}
    ...
    {
      \color{red}
      When claiming support that \(\psi\) has value \(v'\) in \ref{nI:inclusion} is distinct from \ref{nI:going-by-value}\dots
...
\begin{note}[Focus point]
  We have argued that \ref{nI:claimed-support} to \ref{nI:inclusion} are satisfied in the scenarios of interest.
