...
\subsection{Refining ideas through assumptions}
...
\subsubsection{Two optional assumptions}
...
\subsubsection{Illustrations with respect to ideas}
...
\subsubsection{Illustrations with respect to assumptions}
...
\subsubsection{A corollary and a conjecture}
...
\subsubsection{Initial illustrations}
...
\subsection{Constraints on reasoning with \gsi{} given \ESU{}}
...
\subsubsection{Illustrations for intuition}
...
\subsection{Details of --- and argument for --- \nI{}}
\label{sec:details-ni}
\label{sec:re-do-ni}

\subsubsection*{Argument outline}
...
\subsubsection{Laying out the clauses}
...
\subsubsection{Second, move to \(\phi\), need \(\psi\)}
...
\subsubsection{Entertaining \(\lnot\psi\)}
...
\subsubsection*{A handful of observations}
...
\subsubsection{Variations on earlier examples}
...
\subsubsection{Illustrations where \nI{} does not apply}
...
\subsection{Contrast to other conditions}
...
\subsubsection{Wright on warrant transmission (failure)}
...
\paragraph{Deny claimed support for ability}
...
\paragraph{Appeal to premises and steps requires appeal to ability}
