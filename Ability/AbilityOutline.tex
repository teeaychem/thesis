...
\begin{note}
  Basic ideas go back (at least) to the Proper Execution Principle of~\textcite[99]{Wright:1991vn}, 
  \cite{Wright:2003aa}~\cite{Wright:2007uz}
\end{note}
...
\begin{note}[The revised template]
  ...
  Where
  \begin{quote}
    A presupposition of a cognitive project is any condition P such that to doubt P (in advance of executing the project) would rationally commit one to doubting the significance, or competence of the project, irrespective of its outcome.\nolinebreak
...
\begin{note}[Entailment]
  Entailment, but this isn't really the main issue.

  For purposes of comparison, suppose that \(\phi\) entails \(\psi\), and hence \ref{nI:received-info} involves claiming support for an entailment.

  I somewhat doubt that entailment is required for \citeauthor{Wright:2011wn}.

  So, the initial condition from \citeauthor{Wright:2011wn}'s template matches \ref{nI:received-info}.

  Therefore, key thing to compare~\ref{WT:i} -- \ref{WT:iii} from \citeauthor{Wright:2011wn}'s template with~\ref{nI:claimed-support},~\ref{nI:inclusion}, and~\ref{nI:going-by-value}.
\end{note}

\begin{note}[Key thing here is presupposition]
  Key issue is this idea of a presupposition.
\end{note}

\begin{note}[Important to note]
  One important thing to note here is that \citeauthor{Wright:2011wn} just focuses on the relation between propositions.
  There's no focus on the way in which the agent transmits warrant.
\end{note}
