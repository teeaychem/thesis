...
\begin{note}[\WR{} and \AR{}]
  ...
  \begin{definition}[\AR{}]\label{A:s}
    \emph{S} has the ability to \emph{V} that \(\phi\) entails that \(\phi\) is the case because having the ability to \emph{V} that \(\phi\) is or entails that \emph{S} has some property \emph{P} and in turn \emph{P} entails that \(\phi\) is the case.
  \end{definition}

  To illustrate.
  I have the ability to prove that the defendant is guilty.
