...
\begin{note}
  \begin{restatable}[Claiming support Nai Strong]{assumption}{assuExpectNaiStrong}\label{assu:expect-nai-strong}
    Reasoning that expectation does not obtain may not depend on claimed support which involves expectation that the defeater does not obtain.
  \end{restatable}
...
\begin{note}
  ...
  Second, claimed support for \(\phi\) having value \(v\) as part of such reasoning.
  ...
  Hence, the task of~\ref{nI:inclusion} is to establish expectation.
\end{note}
