...
\begin{note}
  ...
  \begin{restatable}[Claiming support persists]{proposition}{propRecogniseDefeaters}\label{prop:CS-only-if-reason-recognised-defeaters}
...
\begin{note}
  \begin{restatable}[Claiming support persists]{proposition}{propExpectNai}\label{assu:expect-nai}
