...
\begin{note}
  ...
  From \nfcs{}, agent needs to assume \nmom{}.
  So, assumption about claimed support.
  From \ref{nI:inclusion}, this requires the agent to hold that they're \nmom{} about \(\psi\) having value \(v'\).
  Hence, violation of \eiS{}.

  So, focus of argument is primarily on why~\ref{nI:inclusion} and~\nfcs{} lead to violation of~\eiS{} with respect to \(\psi\) having value \(v'\).
\end{note}
