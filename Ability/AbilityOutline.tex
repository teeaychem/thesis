...
\begin{note}[\WR{} def.]
  ...
  \begin{definition}[\WR{}]
    ...
    \begin{enumerate}
    \item \emph{S} has the ability to \emph{V} that \(\phi\) \emph{if and only if} there is a potential event in which \emph{S} witnesses the act of \emph{V}ing that \(\phi\).
    \item Claim support for details of event.
    \item Details of the event in which \emph{S} witnesses the act of \emph{V}ing that \(\phi\), or part of the event, entails that \(\phi\) is the case.\nolinebreak
