...
\begin{note}[\eiS{}]
  ...
  \begin{proposition}[\eiS{-} --- \eiS{}]\label{prop:supp:independence}
    It is not a requirement of claiming support for some proposition, \(\phi\) that the claimed support is not misled or mistaken.\nolinebreak
    \footnote{
...
\begin{note}
  Easier to illustrate with cases of information for a separate source.
