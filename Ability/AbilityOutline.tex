...
\paragraph{Second (and Third) Assumption}
...
\begin{note}[\eiS{}]
  ...
  \begin{restatable}[\eiS{-} --- \eiS{}]{assumption}{eisProp}\label{prop:supp:independence}
    ...
    {
      \color{red} Only claims support relative to backdrop of considered defeaters.
...
\begin{note}
  \begin{assumption}\label{assu:expect-nai}
    Reasoning is not an instance of claiming support if require expectation that \(\phi\) has value \(v\) in order to conclude that \(\phi\) has value \(v\).
  \end{assumption}
