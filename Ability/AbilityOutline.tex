...
\begin{note}[Quick intuition]
  Primary idea for \nI{} is undercutting defeater.

  Sketch from \textcite{Worsnip:2018aa} for undercutting defeaters.
  \begin{quote}
  ...
  If~\ref{nI:claimed-support},~\ref{nI:received-info} and~\ref{nI:inclusion} then the way of claiming support captured by~\ref{nI:going-by-value} is undercut.
...
\begin{note}[Background to Restriction]
  Core idea of~\ref{nI:going-by-value} is that given~\ref{nI:claimed-support}---\ref{nI:inclusion} as background conditions, agent is prevented from claiming support in a specific way.
  So, primary role of~\ref{nI:going-by-value} is to capture what the way of reasoning is.

  Argument for why~\ref{nI:going-by-value} holds given~\ref{nI:claimed-support}---\ref{nI:inclusion} will be given below.
