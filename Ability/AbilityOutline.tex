...
\begin{note}[Memory]
  ...
  Instance of proving.
  So, something like\dots\nolinebreak
  \footnote{~\cite[557--560]{Barwise:1999tu}}
...
\begin{note}
  \begin{definition}[\adB{}]\label{def:adB}
    ...
    % \item Agent has claimed support that \(\psi\) has value \(v'\) when \(\phi\) has value \(v\).\nolinebreak
      ...
      % }
    \item\label{def:adB:poss} Claimed support for \(\phi\) ensures there is some (distinct) collection of propositions \(\gamma_{1},\dots,\gamma_{k}\) with respective values, such that it is possible to claim support for \(\psi\) having value \(v'\) by appeal to \(\gamma_{1},\dots,\gamma_{k}\) and the respective values.
    \end{enumerate}
    ...
    \item\label{def:adB:inter} Claim support for \(\psi\) having value \(v'\) by appeal to \(\gamma_{1},\dots,\gamma_{k}\) having respective values and the possibility of claiming support for \(\psi\) having value \(v'\) by appeal to \(\gamma_{1},\dots,\gamma_{k}\) and the respective values.
    \end{enumerate}
    \vspace{-\baselineskip}
  \end{definition}
\end{note}
...
\begin{note}
  ...
  Instead, some (distinct) collection of proposition \(\gamma_{1},\dots,\gamma_{k}\).

  Key difference is that agent isn't directly claiming support for \(\psi\) from \(\phi\).
  From \(\gamma_{1},\dots,\gamma_{k}\) to \(\psi\)
  ...
  In turn, the definition does not stated how the agent claims support for \(\gamma_{1},\dots,\gamma_{k}\) having respective values.
  ...
  \begin{itemize}
  \item Because \(\phi\) ensures \(\gamma_{1},\dots,\gamma_{n}\) and \(\psi\) from \(\gamma_{1},\dots,\gamma_{n}\).
  \item Because \(\gamma_{1},\dots,\gamma_{n}\) and \(\phi\) ensures possibility for \(\psi\) from \(\gamma_{1},\dots,\gamma_{n}\).
  \end{itemize}
\end{note}
