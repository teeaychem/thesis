...
\begin{note}
  ...
  \begin{itemize}
  \item we will outline alternative reasoning patterns from~\ref{EAS:ex:box:if} to~\ref{EAS:ex:box:fact}.
    Narrow focus.
    {
      \color{red}
...
\begin{note}[\citeauthor{Moretti:2019wx}]
  ...
  The following quote contains the two clauses of interest.
...
\begin{note}
  ...
  In contrast, \EAS{} {\color{red} \dots}
  ...
  \footnote{
    \color{red}
    There is also simple response which is to deny the combination of~\ref{LT:1.3} and~\ref{LT:2.3}, and consider the enthymematic inferences are complete in the cases in which the agent forms a well founded belief.
