...
\begin{note}[Subjectively sound II]
  \begin{proposition}[M \& M]
    If agent claims support for some proposition, then from the perspective of the agent, the support claimed is robust against being misleading nor mistaken.
  \end{proposition}
