...
\begin{note}
  ...
  For example, consider what \citeauthor{Sgaravatti:2013wu} terms the `Justification Account' of circularity.\nolinebreak
...

    {
      ...
      Hence, \ref{sg:JA} is what explains why it is not possible to entertain possibility.
...
\begin{note}
  Instance of this is \citeauthor{Pryor:2004ws}'s fourth type of dependence between premise and conclusion.
  ...
  This is certainly distinct.

  Assumes evidence against.
  With ideas, just interested in the possibility.\nolinebreak
  \footnote{
    As an aside, compatible with \citeauthor{Pryor:2004ws}'s objection to type 4 dependence.
  ...
  For \citeauthor{Pryor:2004ws}

  \begin{quote}
    I don't think you need antecedent justification to believe (13), before your experiences can give you justification to believe (11). I also think it's plausible that your perceptual justification to believe (11) contributes to the credibility of (13).\nolinebreak
...
\begin{note}
  ...
  Set these aside.
  I do not expect this is particularly novel.
  Rather, stress that it's about entertaining the possibility.
\end{note}
