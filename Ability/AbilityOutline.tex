...
\begin{note}[\ur{} in some detail]
  \begin{definition}[\ur{}]
    When claimed support by appeal to proposition or part of proposition which may refer, the agent \emph{appeals to} the referent of the proposition or part.
  \end{definition}
...
\begin{note}[\nr{} in some detail]
  \begin{definition}[\nr{}]
    When claimed support by appeal to proposition or part of proposition which may refer, the agent \emph{does not appeal to} the referent of the proposition or part.
  \end{definition}
...
\begin{note}[Two things]
  ...
  Question about how to obtain \ref{ill:iDogd:mixed} from initial premise, and how to obtain conclusion from \ref{ill:iDogd:done}, but there doesn't seem to be mystery about what is going on.
...
\begin{note}
  ...
  To make parallel explicit, we'll stick close to standard semantic clauses.
  Then, expand after.
...
\begin{note}[Example, \ur{}]
    ...
    % \item[\(\protect\iDog\)\space P.] The dog is \RIPa{} and \RIPb{}.
    \item\label{ill:iDog:mixed} \(\sem{w} \in \sem{\RIPa{-} \& \RIPb{} dog}\)
    \item\label{ill:iDog:sep-gen} \(\sem{\RIPa{-} and \RIPb{} dog} \subseteq (\sem{\RIPa{-} dog} \cap \sem{\RIPb{-} dog})\)
    \item\label{ill:iDog:sep-app} \emph{If} \(\sem{w} \in \sem{\RIPa{-} \& \RIPb{} dog}\) \emph{then}, \(\sem{w} \in \sem{\RIPa{-} dog}\) \emph{and} \(\sem{w} \in \sem{\RIPb{-} dog}\)
    \item \(\sem{w} \in \sem{\RIPa{-} dog}\) and \(\sem{w} \in \sem{\RIPb{-} dog}\)
    \item\label{ill:iDog:sep-res} \(\sem{w} \in \sem{\RIPb{-} dog}\)
    % \item[\(\protect\iDog\)\space C.] Hence, the dog is \RIPb{}.
    \end{enumerate}
    \vspace{-\baselineskip}
  \end{illustration}
\end{note}
...
\begin{note}
  Start with~\ref{ill:iDog:mixed}.

  Reference of \(w\) is a member of the reference of `\RIPa{-} \& \RIPb{} dog'.
  ...
  \ref{ill:iDog:sep-gen} --- what it is to be \RIPa{} \& \RIPb{}.
  Separable qualities.
\end{note}


\begin{note}[More difficult part]
  \ref{ill:iDog:sep-app}
  \begin{itemize}
  \item If \nagent{10} is \dots, then \nagent{10} is \dots and \dots
  \end{itemize}
  Or
  \begin{itemize}
  \item If refer to \nagent{10} is \dots, then refer to \nagent{10} by distinct predicates\dots
  \end{itemize}
\end{note}
...
\begin{note}[Example with an existential]
  ...
  \begin{illustration}
    \vspace{-\baselineskip}
    \begin{enumerate}[label=\(\protect\iEDogd\)\space\arabic*.]
  ...
  \begin{illustration}
    \vspace{-\baselineskip}
    \begin{enumerate}[label=\(\protect\iEDog\)\space\arabic*.]
