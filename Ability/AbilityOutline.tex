...
\begin{note}[Main idea]
  ...
  Overall role of inclusion is to establish a relation between claiming support for \(\phi\) and claiming support for \(\psi\).
...
\begin{note}[Kay role of \ref{nI:inclusion:position}]
  Most of the issue are going to arise from \ref{nI:inclusion:bond}.
  However,\ref{nI:inclusion:position} is important as \ref{nI:inclusion:bond} is a counterfactual.
