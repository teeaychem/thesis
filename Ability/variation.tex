...
\begin{note}
  ...
  \begin{restatable}[\qWhyV{}]{question}{questionWhyV}
    ...
    \begin{itemize}
    \item
      Which proposition-value-premises pairings \(\pvp{\psi}{v'}{\Psi}\) are such that:
    ...
    \end{itemize}
    \vspace{-\baselineskip}
    % I think I want this definition.
    % For, it means that the agent doesn't need to keep the \ros{} in mind when the agent makes the conclusion.
  \end{restatable}
