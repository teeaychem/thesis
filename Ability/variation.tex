...
\begin{note}
  ...
  \item
    `How' is eliminated from \qHow{} in favour of events which serve to \wit{0} any \ros{} that the \agents{} conclusion of \(\pv{\phi}{v}\) from \(\Phi\) depended on.
  \end{itemize}
...
\begin{note}
  Though I consider \qWhyVnP{} to express a somewhat intuitive idea, the question is imprecise in two significant ways:
  \begin{itemize}[noitemsep]
  \item
...
\begin{note}
  ...
  The connexion between dependence and explanation of why links \qWhyVnP{} and \qWhy{} in the following way:
  ...
  In short, \linkW{} states that dependence captured by \qWhyVnP{} is sufficient to explain why an agent concluded \(\pv{\phi}{v}\) from \(\Phi\).
\end{note}
