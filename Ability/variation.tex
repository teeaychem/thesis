    ...
    \item
      ...
      \item
        ...
        \item[\emph{Then}:]
          ...
          \item
            \label{q:why:v:then}
            \(e^{\flat}\) did not develop into an event \(e'\) such that \(d\) is true of \(e'\).
          \end{enumerate}
        \end{enumerate}
      \end{itemize}
    \end{itemize}
...
\begin{note}
  ...
  \begin{scenario}[A cup of tea]
    ...
    \item
      And, the removed the tea bag.
    \end{itemize}
  \end{scenario}

  Claim that boiling the kettle captures, in part, why I made a cup of tea.

  Sense of why in which this is inappropriate.
  From means-end perspective, want to understand what my end was.
  Conclusion, not motivation, but why \(\pv{\phi}{v}\) from \(\Phi\) as opposed to some other conclusion, or not conclusion.
  Parallel, why it was that I made tea, instead of something else by my actions.

  Consider boiling the kettle.
  Suppose I had not done this.
  For example, distracted, and forgot.
  Then, rather than a cup of tea, cup of regret.
  Without hot water, no infusion.

  So, without boiling water event continues, but is impeded from developing in%to an event in which make a cup of tea.

  With \qWhyV{}, absence of \ros{} is parallel to cold water.
