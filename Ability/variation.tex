  ...
  \begin{question}{questionWhyV}{\qWhyV{}}
    ...
    \item
      ...
      \item
        ...
        \item
          There is some sub-event \(e^{\flat}\) of \(e\) and \(d\) is true of \(e^{\flat}\).
        \item
...
\begin{note}
  ...
  \footnote{
    ...
    For, consider adding to the description of~\autoref{illu:coinT} that agent \(A\) is dishonest and will run before handing anything \(B\), or that neither agent really has \texteuro{}5 at hand and are hoping they win, or \dots
...
\begin{note}
  ...
  From a broad perspective, approach to why parallels \citeauthor{Hempel:1965aa}'s Deductive-Nomological account of scientific explanation:
    ...
    Event is relevant circumstance, and description captures laws which hold with respect to circumstance.
    Why is given in terms of which \ros{} appeared in something lawlike.
\end{note}
...
\begin{note}
  ...
  For example, I wasn't cold-brewing tea, and I didn't have time to boil the water after noticing it was cold.
  So, as long as the conditional is true for the sub-event as it happened, we may add to our description of the sub-event to secure the truth of the conditional without fully describing the event.
\end{note}

\begin{note}
  There is a clear sense with which the description given to the event captures \emph{how} I made a cup of tea.
  Indeed, with a little adjustment the description of \autoref{scen:cup-of-tea} functions as a series of instructions for how to make a cup of tea.

  And, there is also a sense with which the description explains \emph{why} I made a cup of tea.
  ...
  \begin{link}[\qHowV{} and \qHow{}]
    ...
    \item
      ...
      \item
        ...
        \(e\) is an event in which an agent concludes a prop.\ has a value.
        \end{enumerate}
      \item[\emph{Then}:]
        \(e\) answers \qHowV{}.
      \end{itenum}
