...
\begin{note}
  ...
  \begin{question}{questionWhyR}{\qWhyR{}}
    ...
    \begin{itemize}
    \item
      Which rationalisations partly explain \emph{why} \(e\) is an \eiw{0} \vAgent{} does \(a\)?
    \end{itemize}
  ...
  \begin{question}{questionHowR}{\qHowR{}}
    ...
    \begin{itemize}
    \item
      Which past or present events partly explain \emph{how} \(e\) is an \eiw{0} \vAgent{} does \(a\)?
    \end{itemize}
    \vspace{-1.5\baselineskip}
  \end{question}

  \noindent%
  \qWhy{} seeks an understanding of the way an event developed such that an agent concludes \(\phi\) has value \(v\) from \(\Phi\) in terms of \fingfr{1}.
  ...
  Likewise, \qHowR{} seeks an understanding of the way an event developed such that an agent did some action in terms of what happened, and \qHow{} is a restriction of \qHowR{} to \eiw{1} the relevant action is `concludes \(\phi\) has value \(v\) from \(\Phi\)'.
\end{note}
