...
\begin{note}
  ...
  Similar to \citeauthor{Davidson:1963aa}.
  \citeauthor{Armstrong:1968vh}'s account is not that there is some causal account.
  Rather, the agent's belief is the cause.
  This is what gets \issueConstraint{}.
\end{note}
