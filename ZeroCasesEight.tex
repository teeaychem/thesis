...
\begin{note}[Understanding of transmission]
  ...
  Interesting cases is where the conclusion is the result of some entailment.
...
\begin{note}[Slight divergence from literature]
    Slight divergence from core literature on failure of transmission, as work in terms of type of support.
\end{note}
...
\begin{note}[Factive inference]
  ...
  So, the fact doesn't follow from the attitude.
\end{note}
