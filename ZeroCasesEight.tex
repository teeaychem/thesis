...
\begin{note}[Classic]
  Granting for the moment that there is something odd about obtaining \emph{B} from \emph{E} and the entailment from \emph{A} to \emph{B}, we may reformulate \citeauthor{Dretske:2005vy}'s case with the use of a factive verb to establish closer surface parallels to the chess case.
  \begin{enumerate}
