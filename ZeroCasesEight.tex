...
\begin{note}[Introduction, summarising previous section and interest]
  ...
  \item\label{as:1}\label{inf:cond:ant} I have the ability to reason with the rules of chess.
  \item\label{as:2}\label{inf:cond} If I have the ability to reason with the rules of chess then I have the ability to demonstrate the existence of a (specific) strategy.
  \end{enumerate}
  ...
  \item\label{as:4}\label{inf:cond:conq} I have the ability to demonstrate the existence of the (particular) strategy.
  \end{enumerate}
  Sub-conclusion~\ref{as:4}, is the antecedent of the following conditional:
  \begin{enumerate}[resume, label=(S\arabic*), ref=(S\arabic*)]
  \item\label{as:3}\label{inf:gae} For any strategy, an agent has the ability to demonstrate the existence of the strategy only if the strategy exists.
  \end{enumerate}
  Therefore:
  \begin{enumerate}[resume, label=(S\arabic*), ref=(S\arabic*)]
  \item\label{as:5}\label{inf:sse} The (particular) strategy (that I am able to demonstrate) exists.
  \end{enumerate}
  ...
  The agent's goal is to \emph{transmit} support for~\ref{as:4} to~\ref{as:5} \emph{via} the entailment noted in~\ref{as:3} --- from the ability to demonstrate the existence of a (particular) strategy across a (known) entailment to obtain support for the existence of a (particular) strategy.
...
\begin{note}[Introduction, two different types of reasoning]
  ...
  By contrast, \WR{} observes that support for~\ref{inf:cond:conq} may be understood as support for the \emph{generating a witnessing event} of demonstrating that the (specific) strategy exists.
...
\begin{note}[Introduction, attribution and dilemma]
  The present section focuses on \AR{}.
  Our goal is to show that \AR{} is not quite so straightforward as may first appear.
...
\begin{note}[Assumptions for attribution horn of dilemma]
  ...
  With the premise in hand, we then turn to understanding transmission failure, and completing the argument for~\ref{RDil:A}.
\end{note}
...
\begin{note}[Transmission characterisation applied to argument]
  ...
  Condition~\ref{sep:trans:i} is satisfied as for present purposes we assume that the agent obtains irresolute support for the ability to demonstrate that some strategy exists.
...
\begin{note}[After observations]
  Our interest is with condition~\ref{sep:trans:iii}.
  In particular, whether the agent obtains support for the existence of the (particular) strategy, or any other required condition for possessing the ability to demonstrate the existence of the (particular) strategy \emph{in virtue} of the agent possessing the attribute of being able to demonstrate the existence of the (particular) strategy.
\end{note}
