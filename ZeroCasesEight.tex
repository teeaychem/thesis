...
\begin{note}[Attribution outline]
  ...
  \begin{itemize}
  \item Novel information provides inconclusive  support.
  \item Inconclusive support is insufficient for factive inference.
  \end{itemize}
...
\begin{note}[Attribution sketch]
  Attribution raises a problem.

  Conditional is novel information, only contains ability claim, and specifically in the antecedent --- assumed for now.
  Novel information, changes perspective on general ability.
  Now prior stands in defeasible support relation to having ability.
  In turn, failure of transmission of support.

  Same goes for witnessing, but the agent is relying on the witness, rather than the attribute.
...
\begin{note}[Through sketch, summary]
  {
    ...
    This is difficult with the argument expressed in stakes.
  }
