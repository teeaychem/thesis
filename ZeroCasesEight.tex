...
\begin{note}[Contrast to Wright]
  ...
  Still, alligns with the template, in a sense, because the template suggests that there's got to be some doubt about whether the identified entailment actually holds.
