...
\begin{note}[Two ways of reading the argument]
...
\begin{note}[First part focus]
  ...
  Sketch the problem, general upshots, and then proceed to arguments in detail.
\end{note}

\begin{note}[Attribution sketch]
...
\begin{note}[Gist of problem]
  Really important point is a structural defect.
  With attribution, support fails.
  With witnessing, support can be added later.
\end{note}
