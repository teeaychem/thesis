...
\begin{note}[A quick summary of the reasoning of interest]
  ...
  In summary, the proposed result of this reasoning is to extend support for the ability to demonstrate the existence of a (particular) strategy across a (known) entailment.
...
\begin{note}[Handful of observations]
  ...
  First, the entailment from the agent possessing the (specific) ability to demonstrate the existence of a strategy to the existence of a strategy is due to the factivity of the verb `demonstrate'.
  We may replace demonstrate with some other verb and obtain the same entailment.
